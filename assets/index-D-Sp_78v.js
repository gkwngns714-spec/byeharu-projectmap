...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Co(){return new Cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Po(){return new Cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
	...
	`}function df(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,u=l===Gs||l===Vs,c=l===vi||l===xi;if(u||c){let p=e.get(a);const d=p!==void 0?p.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new wo(i)),p=u?t.fromEquirectangular(a,p):t.fromCubemap(a,p),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),p.texture;if(p!==void 0)return p.texture;{const m=a.image;return u&&m&&m.height>0||c&&m&&r(m)?(t===null&&(t=new wo(i)),p=u?t.fromEquirectangular(a):t.fromCubemap(a),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),a.addEventListener("dispose",s),p.texture):null}}}return a}function r(a){let l=0;const u=6;for(let c=0;c<u;c++)a[c]!==void 0&&l++;return l===u}function s(a){const l=a.target;l.removeEventListener("dispose",s);const u=e.get(l);u!==void 0&&(e.delete(l),u.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function hf(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Lr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function ff(i,e,t,n){const r={},s=new WeakMap;function o(p){const d=p.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);for(const _ in d.morphAttributes){const x=d.morphAttributes[_];for(let f=0,h=x.length;f<h;f++)e.remove(x[f])}d.removeEventListener("dispose",o),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(p,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(p){const d=p.attributes;for(const _ in d)e.update(d[_],i.ARRAY_BUFFER);const m=p.morphAttributes;for(const _ in m){const x=m[_];for(let f=0,h=x.length;f<h;f++)e.update(x[f],i.ARRAY_BUFFER)}}function u(p){const d=[],m=p.index,_=p.attributes.position;let x=0;if(m!==null){const T=m.array;x=m.version;for(let S=0,b=T.length;S<b;S+=3){const U=T[S+0],C=T[S+1],R=T[S+2];d.push(U,C,C,R,R,U)}}else if(_!==void 0){const T=_.array;x=_.version;for(let S=0,b=T.length/3-1;S<b;S+=3){const U=S+0,C=S+1,R=S+2;d.push(U,C,C,R,R,U)}}else return;const f=new(Al(d)?Dl:Ll)(d,1);f.version=x;const h=s.get(p);h&&e.remove(h),s.set(p,f)}function c(p){const d=s.get(p);if(d){const m=p.index;m!==null&&d.version<m.version&&u(p)}else u(p);return s.get(p)}return{get:a,update:l,getWireframeAttribute:c}}function pf(i,e,t){let n;function r(d){n=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,m){i.drawElements(n,m,s,d*o),t.update(m,n,1)}function u(d,m,_){_!==0&&(i.drawElementsInstanced(n,m,s,d*o,_),t.update(m,n,_))}function c(d,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,d,0,_);let f=0;for(let h=0;h<_;h++)f+=m[h];t.update(f,n,1)}function p(d,m,_,x){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let h=0;h<d.length;h++)u(d[h]/o,m[h],x[h]);else{f.multiDrawElementsInstancedWEBGL(n,m,0,s,d,0,x,0,_);let h=0;for(let T=0;T<_;T++)h+=m[T];for(let T=0;T<x.length;T++)t.update(h,n,x[T])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=u,this.renderMultiDraw=c,this.renderMultiDrawInstances=p}function mf(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function gf(i,e,t){const n=new WeakMap,r=new nt;function s(o,a,l){const u=o.morphTargetInfluences,c=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,p=c!==void 0?c.length:0;let d=n.get(a);if(d===void 0||d.count!==p){let G=function(){R.dispose(),n.delete(a),a.removeEventListener("dispose",G)};d!==void 0&&d.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,x=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],h=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let S=0;m===!0&&(S=1),_===!0&&(S=2),x===!0&&(S=3);let b=a.attributes.position.count*S,U=1;b>e.maxTextureSize&&(U=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const C=new Float32Array(b*U*4*p),R=new Rl(C,b,U,p);R.type=Kt,R.needsUpdate=!0;const w=S*4;for(let g=0;g<p;g++){const E=f[g],X=h[g],V=T[g],$=b*U*4*g;for(let Z=0;Z<E.count;Z++){const A=Z*w;m===!0&&(r.fromBufferAttribute(E,Z),C[$+A+0]=r.x,C[$+A+1]=r.y,C[$+A+2]=r.z,C[$+A+3]=0),_===!0&&(r.fromBufferAttribute(X,Z),C[$+A+4]=r.x,C[$+A+5]=r.y,C[$+A+6]=r.z,C[$+A+7]=0),x===!0&&(r.fromBufferAttribute(V,Z),C[$+A+8]=r.x,C[$+A+9]=r.y,C[$+A+10]=r.z,C[$+A+11]=V.itemSize===4?r.w:1)}}d={count:p,texture:R,size:new Ve(b,U)},n.set(a,d),a.addEventListener("dispose",G)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let m=0;for(let x=0;x<u.length;x++)m+=u[x];const _=a.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",u)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function _f(i,e,t,n){let r=new WeakMap;function s(l){const u=n.render.frame,c=l.geometry,p=e.get(l,c);if(r.get(p)!==u&&(e.update(p),r.set(p,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==u&&(d.update(),r.set(d,u))}return p}function o(){r=new WeakMap}function a(l){const u=l.target;u.removeEventListener("dispose",a),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:s,dispose:o}}class Bl extends _t{constructor(e,t,n,r,s,o,a,l,u,c=hi){if(c!==hi&&c!==Si)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&c===hi&&(n=Vn),n===void 0&&c===Si&&(n=Mi),super(null,r,s,o,a,l,c,n,u),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:yt,this.minFilter=l!==void 0?l:yt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const zl=new _t,Lo=new Bl(1,1),kl=new Rl,Hl=new nu,Gl=new Nl,Do=[],Io=[],Uo=new Float32Array(16),No=new Float32Array(9),Fo=new Float32Array(4);function wi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Do[r];if(s===void 0&&(s=new Float32Array(r),Do[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function at(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ot(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function qr(i,e){let t=Io[e];t===void 0&&(t=new Int32Array(e),Io[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function vf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function xf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2fv(this.addr,e),ot(t,e)}}function Mf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;i.uniform3fv(this.addr,e),ot(t,e)}}function Sf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4fv(this.addr,e),ot(t,e)}}function Ef(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Fo.set(n),i.uniformMatrix2fv(this.addr,!1,Fo),ot(t,n)}}function yf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;No.set(n),i.uniformMatrix3fv(this.addr,!1,No),ot(t,n)}}function bf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Uo.set(n),i.uniformMatrix4fv(this.addr,!1,Uo),ot(t,n)}}function Tf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Af(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2iv(this.addr,e),ot(t,e)}}function wf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3iv(this.addr,e),ot(t,e)}}function Rf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4iv(this.addr,e),ot(t,e)}}function Cf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Pf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2uiv(this.addr,e),ot(t,e)}}function Lf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3uiv(this.addr,e),ot(t,e)}}function Df(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4uiv(this.addr,e),ot(t,e)}}function If(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Lo.compareFunction=Tl,s=Lo):s=zl,t.setTexture2D(e||s,r)}function Uf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Hl,r)}function Nf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Gl,r)}function Ff(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||kl,r)}function Of(i){switch(i){case 5126:return vf;case 35664:return xf;case 35665:return Mf;case 35666:return Sf;case 35674:return Ef;case 35675:return yf;case 35676:return bf;case 5124:case 35670:return Tf;case 35667:case 35671:return Af;case 35668:case 35672:return wf;case 35669:case 35673:return Rf;case 5125:return Cf;case 36294:return Pf;case 36295:return Lf;case 36296:return Df;case 35678:case 36198:case 36298:case 36306:case 35682:return If;case 35679:case 36299:case 36307:return Uf;case 35680:case 36300:case 36308:case 36293:return Nf;case 36289:case 36303:case 36311:case 36292:return Ff}}function Bf(i,e){i.uniform1fv(this.addr,e)}function zf(i,e){const t=wi(e,this.size,2);i.uniform2fv(this.addr,t)}function kf(i,e){const t=wi(e,this.size,3);i.uniform3fv(this.addr,t)}function Hf(i,e){const t=wi(e,this.size,4);i.uniform4fv(this.addr,t)}function Gf(i,e){const t=wi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Vf(i,e){const t=wi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Wf(i,e){const t=wi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Xf(i,e){i.uniform1iv(this.addr,e)}function $f(i,e){i.uniform2iv(this.addr,e)}function qf(i,e){i.uniform3iv(this.addr,e)}function Yf(i,e){i.uniform4iv(this.addr,e)}function Kf(i,e){i.uniform1uiv(this.addr,e)}function jf(i,e){i.uniform2uiv(this.addr,e)}function Zf(i,e){i.uniform3uiv(this.addr,e)}function Jf(i,e){i.uniform4uiv(this.addr,e)}function Qf(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||zl,s[o])}function ep(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Hl,s[o])}function tp(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Gl,s[o])}function np(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||kl,s[o])}function ip(i){switch(i){case 5126:return Bf;case 35664:return zf;case 35665:return kf;case 35666:return Hf;case 35674:return Gf;case 35675:return Vf;case 35676:return Wf;case 5124:case 35670:return Xf;case 35667:case 35671:return $f;case 35668:case 35672:return qf;case 35669:case 35673:return Yf;case 5125:return Kf;case 36294:return jf;case 36295:return Zf;case 36296:return Jf;case 35678:case 36198:case 36298:case 36306:case 35682:return Qf;case 35679:case 36299:case 36307:return ep;case 35680:case 36300:case 36308:case 36293:return tp;case 36289:case 36303:case 36311:case 36292:return np}}class rp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Of(t.type)}}class sp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=ip(t.type)}}class ap{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Rs=/(\w+)(\])?(\[|\.)?/g;function Oo(i,e){i.seq.push(e),i.map[e.id]=e}function op(i,e,t){const n=i.name,r=n.length;for(Rs.lastIndex=0;;){const s=Rs.exec(n),o=Rs.lastIndex;let a=s[1];const l=s[2]==="]",u=s[3];if(l&&(a=a|0),u===void 0||u==="["&&o+2===r){Oo(t,u===void 0?new rp(a,i,e):new sp(a,i,e));break}else{let p=t.map[a];p===void 0&&(p=new ap(a),Oo(t,p)),t=p}}}class Dr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);op(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Bo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const lp=37297;let cp=0;function up(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function dp(i){const e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(i);let n;switch(e===t?n="":e===Or&&t===Fr?n="LinearDisplayP3ToLinearSRGB":e===Fr&&t===Or&&(n="LinearSRGBToLinearDisplayP3"),i){case Pn:case Xr:return[n,"LinearTransferOETF"];case $t:case Fa:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function zo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+up(i.getShaderSource(e),o)}else return r}function hp(i,e){const t=dp(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function fp(i,e){let t;switch(e){case Rc:t="Linear";break;case Cc:t="Reinhard";break;case Pc:t="Cineon";break;case Lc:t="ACESFilmic";break;case Ic:t="AgX";break;case Uc:t="Neutral";break;case Dc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const xr=new O;function pp(){qe.getLuminanceCoefficients(xr);const i=xr.x.toFixed(4),e=xr.y.toFixed(4),t=xr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function _p(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Hi(i){return i!==""}function ko(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ho(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const vp=/^[ \t]*#include +<([\w\d./]+)>/gm;function xa(i){return i.replace(vp,Mp)}const xp=new Map;function Mp(i,e){let t=Le[e];if(t===void 0){const n=xp.get(e);if(n!==void 0)t=Le[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return xa(t)}const Sp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Go(i){return i.replace(Sp,Ep)}function Ep(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Vo(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function yp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===oc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(e="SHADOWMAP_TYPE_VSM"),e}function bp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case vi:case xi:e="ENVMAP_TYPE_CUBE";break;case Wr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Tp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case xi:e="ENVMAP_MODE_REFRACTION";break}return e}function Ap(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ra:e="ENVMAP_BLENDING_MULTIPLY";break;case Ac:e="ENVMAP_BLENDING_MIX";break;case wc:e="ENVMAP_BLENDING_ADD";break}return e}function wp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Rp(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=yp(t),u=bp(t),c=Tp(t),p=Ap(t),d=wp(t),m=mp(t),_=gp(s),x=r.createProgram();let f,h,T=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(f=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(Hi).join(`
`),f.length>0&&(f+=`
`),h=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,_].filter(Hi).join(`
`),h.length>0&&(h+=`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <tbody>
        ...
        <tr class="tot"><td>total</td><td>${A}</td><td>${N}</td></tr>
         ...
         <div class="tl-chips">${x.map(te=>E(te.id)).join("")}</div>`:"";let ie;T?f.length?ie=al.map(te=>{const z=f.filter(q=>q.kind===te).sort((q,ce)=>q.label.localeCompare(ce.label));return z.length?`<div class="tl-note">${te} (${z.length})</div>
      ...
      <section class="tl-sec">
        ...
        ${Ie}
      </section>`}return t.addEventListener("click",w=>{const G=w.target.closest("[data-goto]");!G||!t.contains(G)||(s=G.dataset.goto,n?.(s),R())}),R(),{setQuery(w){r=w.trim().toLowerCase(),R()}}}const Fm={system:5.2,rung:4.6,phase:4.2,flag:3.4,table:2.4,migration:1.7,function:1.3},Xl=["creates","supersedes","extends","alters","drops","seeds","gated-by","calls","touches","owned-by","delivers","delivered-by","flips","waits-on"],Om={creates:"migration defines a function/table",supersedes:"migration re-creates a function an earlier one defined",extends:"migration alters a table an earlier one created",alters:"migration changes a table",drops:"migration removes a function",seeds:"migration inserts a game_config flag","gated-by":"migration reads a flag to gate behaviour",calls:"function calls another function",touches:"function reads/writes a table","owned-by":"table belongs to a system (sole writer)",delivers:"a plan slice delivers this feature gate","delivered-by":"a plan slice was delivered by this migration",flips:"an activation rung flips this flag","waits-on":"this rung waits on the one before it"},ol="./",[It,Mn]=await Promise.all([fetch(`${ol}graph.json`).then(i=>i.json()),fetch(`${ol}live.json`).then(i=>i.json()).catch(()=>null)]),{status:hn,why:Bm,frontier:ll}=bm(It,Mn),Jt=Sm(It.nodes,It.edges),Xn=new Map(Jt.map(i=>[i.id,i]));new Map(Jt.map((i,e)=>[i.id,e]));const En=new Map;for(const i of It.edges)En.has(i.source)||En.set(i.source,[]),En.has(i.target)||En.set(i.target,[]),En.get(i.source).push({...i,dir:"out",other:i.target}),En.get(i.target).push({...i,dir:"in",other:i.source});const yi=document.getElementById("scene"),Wa=new om({canvas:yi,antialias:!0});Wa.setPixelRatio(Math.min(devicePixelRatio,2));const Ri=new lm;Ri.fog=new Ha(461071,.0016);const un=new Ft(58,1,1,6e3);Ri.add(new vm(16777215,1.5));const $l=new _m(16777215,1.1);$l.position.set(1,1,1);Ri.add($l);const zm=new Ga(1,14,10),km=new pm({transparent:!0}),Yt=new dm(zm,km,Jt.length);Yt.instanceColor=new Ma(new Float32Array(Jt.length*3),3);Ri.add(Yt);const Tr=new ct,pi=new Float32Array(Jt.length*3);Jt.forEach((i,e)=>{const t=new Ne(hn.get(i.id).color);pi[e*3]=t.r,pi[e*3+1]=t.g,pi[e*3+2]=t.b});const $i=new Zt,yn=new Float32Array(It.edges.length*6),Ir=new Float32Array(It.edges.length*6);It.edges.forEach((i,e)=>{const t=Xn.get(i.source),n=Xn.get(i.target);yn.set([t.x,t.y,t.z,n.x,n.y,n.z],e*6)});$i.setAttribute("position",new Dt(yn,3));$i.setAttribute("color",new Dt(Ir,3));const Hm=new fm($i,new Vl({vertexColors:!0,transparent:!0,opacity:.3,depthWrite:!1,blending:Ds}));Ri.add(Hm);const et={status:new Set(Va),kind:new Set(["system","rung","phase","flag","table","migration","function"]),edge:new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),query:"",selected:null},Gm=i=>!et.query||i.label.toLowerCase().includes(et.query)||(i.detail??"").toLowerCase().includes(et.query);function Gi(i){return et.status.has(hn.get(i.id).key)&&et.kind.has(i.kind)&&Gm(i)}function Ci(){const i=et.selected,e=i?new Set([i,...(En.get(i)??[]).map(r=>r.other)]):null;let t=0;Jt.forEach((r,s)=>{const o=Gi(r);o&&t++;const a=e&&!e.has(r.id),l=o?Fm[r.kind]*(r.id===i?2.1:1):0;Tr.position.set(r.x,r.y,r.z),Tr.scale.setScalar(o?a?l*.55:l:0),Tr.updateMatrix(),Yt.setMatrixAt(s,Tr.matrix);const u=a?.22:1;Yt.instanceColor.array[s*3]=pi[s*3]*u,Yt.instanceColor.array[s*3+1]=pi[s*3+1]*u,Yt.instanceColor.array[s*3+2]=pi[s*3+2]*u}),Yt.instanceMatrix.needsUpdate=!0,Yt.instanceColor.needsUpdate=!0;let n=0;It.edges.forEach((r,s)=>{const o=Xn.get(r.source),a=Xn.get(r.target),l=et.edge.has(r.type)&&Gi(o)&&Gi(a)&&(!e||e.has(r.source)&&e.has(r.target));l&&n++;const u=l?new Ne(hn.get(r.source).color):null;for(let c=0;c<2;c++){const p=s*6+c*3;if(Ir[p]=u?u.r:0,Ir[p+1]=u?u.g:0,Ir[p+2]=u?u.b:0,!l)yn[p]=0,yn[p+1]=0,yn[p+2]=0;else{const d=c===0?o:a;yn[p]=d.x,yn[p+1]=d.y,yn[p+2]=d.z}}}),$i.attributes.position.needsUpdate=!0,$i.attributes.color.needsUpdate=!0,jm(t,n)}const ql=i=>Jt.reduce((e,t)=>(e[i(t)]=(e[i(t)]??0)+1,e),{}),Vm=ql(i=>hn.get(i.id).key),Wm=ql(i=>i.kind),Xm=It.edges.reduce((i,e)=>(i[e.type]=(i[e.type]??0)+1,i),{});function Yr({id:i,label:e,color:t,count:n,checked:r,title:s,onChange:o}){const a=document.createElement("label");return a.className="row",s&&(a.title=s),a.innerHTML=`<input type="checkbox" ${r?"checked":""}/>
    ${t?`<span class="swatch" style="background:${t}"></span>`:""}
    <span>${e}</span><span class="count">${n}</span>`,a.querySelector("input").addEventListener("change",l=>{o(l.target.checked),Ci()}),a}const $m=document.getElementById("statusFilters");for(const i of Va){const e=be[i];$m.append(Yr({label:e.label,color:e.hex,count:Vm[i]??0,checked:!0,title:e.desc,onChange:t=>t?et.status.add(i):et.status.delete(i)}))}const qm=document.getElementById("kindFilters");for(const i of["rung","phase","system","flag","table","migration","function"])qm.append(Yr({label:i,count:Wm[i]??0,checked:!0,onChange:e=>e?et.kind.add(i):et.kind.delete(i)}));const Ym=document.getElementById("edgeFilters");for(const i of Xl)Ym.append(Yr({label:i,count:Xm[i]??0,checked:et.edge.has(i),title:Om[i],onChange:e=>e?et.edge.add(i):et.edge.delete(i)}));let ba=!1;document.getElementById("cameraOptions").append(Yr({label:"Auto-rotate",count:"",checked:ba,title:"Slowly orbit the map on its own while you are not dragging or flying",onChange:i=>{ba=i}}));document.getElementById("search").addEventListener("input",i=>{const e=i.target.value;if(Vr==="tree"){Tn?.setQuery(e);return}if(Vr==="timeline"){Aa?.setQuery(e);return}et.query=e.trim().toLowerCase(),Ci()});document.getElementById("reset").addEventListener("click",()=>{et.status=new Set(Va),et.kind=new Set(["rung","phase","system","flag","table","migration","function"]),et.edge=new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),et.query="",et.selected=null,document.getElementById("search").value="",document.querySelectorAll("#statusFilters input, #kindFilters input").forEach(i=>{i.checked=!0}),document.querySelectorAll("#edgeFilters input").forEach((i,e)=>{i.checked=et.edge.has(Xl[e])}),document.getElementById("inspect").classList.remove("on"),mt.set(0,0,0),bt=520,Ci()});const Km=document.getElementById("subtitle");Km.textContent=`${It.counts.nodes} nodes · ${It.counts.edges} connections`;function jm(i,e){const t=document.getElementById("hud"),n=Mn?.sources?.gameConfig?.ok,r=Mn?.fetchedAt?new Date(Mn.fetchedAt).toLocaleString():"—",s=Mn?.deploy?.state??"unknown",o=s!=="success";t.innerHTML=`
    ...
    ${ll.missingFrom?`&nbsp;|&nbsp; <span class="warn">prod is behind main from ${ll.missingFrom} onward</span>`:""}
    &nbsp;|&nbsp; read ${r}
    <br><b>drag</b> rotate · <b>WASD / arrows</b> fly · <b>Q / E</b> down·up · <b>scroll</b> zoom · <b>shift- or right-drag</b> pan`}function Zm(i){const e=document.getElementById("inspect");if(!i){e.classList.remove("on");return}const t=Xn.get(i),n=hn.get(i),r=En.get(i)??[],s={};for(const o of r){const a=`${o.dir==="out"?"":"← "}${o.type}`;(s[a]??=[]).push(o)}e.classList.add("on"),e.innerHTML=`
    ...
    <div class="why">${Bm.get(i)??""}</div>
    ${t.file?`<div class="file">${t.file}</div>`:""}
    ${t.detail?`<div class="det">${t.detail}</div>`:""}
    <div class="rel">
      ${Object.entries(s).map(([o,a])=>`
        <h4>${o} (${a.length})</h4>
        ${a.slice(0,22).map(l=>{const u=Xn.get(l.other),c=hn.get(l.other);return`<div data-goto="${l.other}">
            <span class="swatch" style="background:${c.hex}"></span>
            <span>${u.label}</span>${l.note?`<span class="t">${l.note}</span>`:""}</div>`}).join("")}
        ${a.length>22?`<div class="t">…${a.length-22} more</div>`:""}
      `).join("")}
    </div>`,e.querySelectorAll("[data-goto]").forEach(o=>{o.addEventListener("click",()=>Gr(o.dataset.goto))})}function Gr(i){if(et.selected=i,Zm(i),i){const e=Xn.get(i);mt.set(e.x,e.y,e.z),bt=Math.min(bt,340)}Ci()}const Yl=document.getElementById("menuBtn"),Kl=document.getElementById("scrim");function Xa(i){document.getElementById("controls").classList.toggle("open",i),Kl.classList.toggle("on",i),Yl.setAttribute("aria-expanded",String(i))}Yl.addEventListener("click",()=>Xa(!document.getElementById("controls").classList.contains("open")));Kl.addEventListener("click",()=>Xa(!1));addEventListener("keydown",i=>{i.key==="Escape"&&Xa(!1)});const mt=new O(0,0,0);let bt=520,on=.7,mi=.35,St=null;const pt=new Set,Jm=new Set(["w","a","s","d","q","e"," ","arrowup","arrowdown","arrowleft","arrowright"]),Qm=()=>{const i=document.activeElement;return!!i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT")};addEventListener("keydown",i=>{if(Vr!=="map"||Qm())return;const e=i.key.toLowerCase();Jm.has(e)&&(pt.add(e),e===" "&&i.preventDefault())});addEventListener("keyup",i=>pt.delete(i.key.toLowerCase()));addEventListener("blur",()=>pt.clear());yi.addEventListener("contextmenu",i=>i.preventDefault());const Vi=new O,cl=new O,Ur=new O;function jl(){const i=innerWidth,e=innerHeight;Wa.setSize(i,e,!1),un.aspect=i/e,un.updateProjectionMatrix()}addEventListener("resize",jl);jl();const Lt=new Map;let ui=null;const Zl=()=>{const[i,e]=[...Lt.values()];return Math.hypot(i.x-e.x,i.y-e.y)};yi.addEventListener("pointerdown",i=>{yi.setPointerCapture?.(i.pointerId),Lt.set(i.pointerId,{x:i.clientX,y:i.clientY}),Lt.size===2?(ui={d:Zl(),dist:bt},St=null):Lt.size===1&&(St={x:i.clientX,y:i.clientY,moved:!1,pan:i.button===2||i.shiftKey})});function Jl(i){const e=Lt.size;if(Lt.delete(i.pointerId),e===1&&St&&!St.moved&&tg(i),Lt.size<2&&(ui=null),Lt.size===0)St=null;else if(Lt.size===1){const[t]=[...Lt.values()];St={x:t.x,y:t.y,moved:!0}}}addEventListener("pointerup",Jl);addEventListener("pointercancel",Jl);addEventListener("pointermove",i=>{if(Lt.has(i.pointerId)&&Lt.set(i.pointerId,{x:i.clientX,y:i.clientY}),Lt.size===2&&ui){const e=Zl();e>0&&ui.d>0&&(bt=Math.max(40,Math.min(2200,ui.dist*(ui.d/e))));return}if(St){const e=i.clientX-St.x,t=i.clientY-St.y;if(Math.abs(e)+Math.abs(t)>3&&(St.moved=!0),St.pan){un.matrixWorld.extractBasis(Vi,cl,Ur);const n=bt*.0016;mt.addScaledVector(Vi,-e*n),mt.addScaledVector(cl,t*n)}else on-=e*.005,mi=Math.max(-1.5,Math.min(1.5,mi-t*.005));St.x=i.clientX,St.y=i.clientY}else i.pointerType==="mouse"&&eg(i)});const ul=new O,dl=new O,hl=new Sn;yi.addEventListener("wheel",i=>{i.preventDefault();const e=Math.max(40,Math.min(2200,bt*(1+Math.sign(i.deltaY)*.11))),t=e/bt;if(t!==1){gi.x=i.clientX/innerWidth*2-1,gi.y=-(i.clientY/innerHeight)*2+1,Wi.setFromCamera(gi,un);let n=null;for(const r of Wi.intersectObject(Yt))if(Gi(Jt[r.instanceId])){n=ul.copy(r.point);break}n||(un.getWorldDirection(dl),hl.setFromNormalAndCoplanarPoint(dl,mt),n=Wi.ray.intersectPlane(hl,ul)),n&&mt.lerp(n,1-t)}bt=e},{passive:!1});const Wi=new xm,gi=new Ve;function Ql(i){gi.x=i.clientX/innerWidth*2-1,gi.y=-(i.clientY/innerHeight)*2+1,Wi.setFromCamera(gi,un);const e=Wi.intersectObject(Yt);for(const t of e){const n=Jt[t.instanceId];if(Gi(n))return n}return null}const ki=document.getElementById("tip");function eg(i){const e=Ql(i);if(yi.style.cursor=e?"pointer":"default",!e){ki.style.display="none";return}const t=hn.get(e.id);ki.style.display="block",ki.style.left=`${i.clientX+13}px`,ki.style.top=`${i.clientY+13}px`,ki.innerHTML=`<span class="swatch" style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.hex};margin-right:6px"></span>${e.label} <span style="color:#8792ab">· ${e.kind}</span>`}function tg(i){const e=Ql(i);Gr(e?e.id:null)}const Ta={roadmap:"The only view that looks forward. Both lists come from FULL_CAPACITY_PLAN.md: the activation ladder (§B) is the ordered flips still owed — violet means everything is deployed and it is only waiting on a human. The development queue (§C) is the slices; grey means planned with nothing built behind it.",system:"Who owns what. Systems come from the sole-writer matrix in SYSTEM_BOUNDARIES. Tables sit under their owner; a function sits under the system whose tables it touches, or — failing that — under the system whose functions it calls. Anything that fits neither is left unclassified rather than forced.",build:"Every migration in the order it landed, grouped by the day git first recorded it — the filename stamps are synthetic and would pile all 205 into one bucket. Each migration lists what it created.",feature:"Every feature gate, and the migrations that seed or read it. Sorted live first, unproven last.",timeline:"The whole arc in one view. Past — every shipped arc, the migration history behind it, and the complete build log from the dev log. Present — what production proves is live, plus the deploy frontier (merged, not yet deployed). Future — the activation ladder still owed and the planned queue."};let Vr="map",Tn=null,Aa=null;function ec(i){Vr=i,document.body.className=i,document.getElementById("treeWrap").classList.toggle("on",i==="tree"),document.getElementById("timelineWrap").classList.toggle("on",i==="timeline"),document.getElementById("scene").style.display=i==="map"?"block":"none",document.querySelectorAll("#tabs button").forEach(t=>t.classList.toggle("on",t.dataset.tab===i));const e=document.getElementById("search");if(e.value="",e.placeholder=i==="tree"?"Search the tree…":i==="timeline"?"Search the timeline…":"Search nodes…",i==="tree"){const t=!Tn;Tn??=Im({graph:It,status:hn,svg:document.getElementById("tree"),onSelect:(n,r)=>{if(n)return Gr(n);const s=document.getElementById("inspect");s.classList.add("on"),s.innerHTML=`<div class="kind">${r?.kind??"group"}</div>
          <h3>${r?.label??""}</h3>
          ...
          <div class="det">${r?.total??0} item(s) beneath this.</div>`}}),t?Tn.setMode(document.getElementById("treeMode").value):Tn.setQuery("")}else i==="timeline"?(Aa??=Nm({graph:It,status:hn,mount:document.getElementById("timeline"),onSelect:t=>Gr(t)}),Aa.setQuery("")):(et.query="",Ci());document.getElementById("treeHint").textContent=Ta[document.getElementById("treeMode").value],document.getElementById("timelineHint").textContent=Ta.timeline}document.querySelectorAll("#tabs button").forEach(i=>{i.addEventListener("click",()=>ec(i.dataset.tab))});document.getElementById("treeMode").addEventListener("change",i=>{Tn?.setMode(i.target.value),document.getElementById("treeHint").textContent=Ta[i.target.value]});document.getElementById("expandAll").addEventListener("click",()=>Tn?.expandAll());document.getElementById("collapseAll").addEventListener("click",()=>Tn?.collapseAll());window.__cam=()=>({dist:bt,yaw:on,pitch:mi});document.getElementById("loading").remove();ec("map");Ci();(function i(){if(requestAnimationFrame(i),pt.size){const e=bt*.02;Ur.set(-Math.sin(on),0,-Math.cos(on)),Vi.set(Math.cos(on),0,-Math.sin(on)),(pt.has("w")||pt.has("arrowup"))&&mt.addScaledVector(Ur,e),(pt.has("s")||pt.has("arrowdown"))&&mt.addScaledVector(Ur,-e),(pt.has("d")||pt.has("arrowright"))&&mt.addScaledVector(Vi,e),(pt.has("a")||pt.has("arrowleft"))&&mt.addScaledVector(Vi,-e),(pt.has("e")||pt.has(" "))&&(mt.y+=e),pt.has("q")&&(mt.y-=e)}un.position.set(mt.x+bt*Math.cos(mi)*Math.sin(on),mt.y+bt*Math.sin(mi),mt.z+bt*Math.cos(mi)*Math.cos(on)),un.lookAt(mt),ba&&!St&&!pt.size&&(on+=4e-4),Wa.render(Ri,un)})();
