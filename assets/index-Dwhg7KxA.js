...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function il(){return new Un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ho(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function sl(){return new Un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ho(),fragmentShader:`
	...
	`}function tp(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===ca||l===da,d=l===Li||l===Pi;if(c||d){let p=e.get(a);const u=p!==void 0?p.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==u)return t===null&&(t=new tl(n)),p=c?t.fromEquirectangular(a,p):t.fromCubemap(a,p),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),p.texture;if(p!==void 0)return p.texture;{const m=a.image;return c&&m&&m.height>0||d&&m&&s(m)?(t===null&&(t=new tl(n)),p=c?t.fromEquirectangular(a):t.fromCubemap(a),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),a.addEventListener("dispose",r),p.texture):null}}}return a}function s(a){let l=0;const c=6;for(let d=0;d<c;d++)a[d]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function np(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&$s("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function ip(n,e,t,i){const s={},r=new WeakMap;function o(p){const u=p.target;u.index!==null&&e.remove(u.index);for(const _ in u.attributes)e.remove(u.attributes[_]);for(const _ in u.morphAttributes){const M=u.morphAttributes[_];for(let f=0,h=M.length;f<h;f++)e.remove(M[f])}u.removeEventListener("dispose",o),delete s[u.id];const m=r.get(u);m&&(e.remove(m),r.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function a(p,u){return s[u.id]===!0||(u.addEventListener("dispose",o),s[u.id]=!0,t.memory.geometries++),u}function l(p){const u=p.attributes;for(const _ in u)e.update(u[_],n.ARRAY_BUFFER);const m=p.morphAttributes;for(const _ in m){const M=m[_];for(let f=0,h=M.length;f<h;f++)e.update(M[f],n.ARRAY_BUFFER)}}function c(p){const u=[],m=p.index,_=p.attributes.position;let M=0;if(m!==null){const T=m.array;M=m.version;for(let y=0,E=T.length;y<E;y+=3){const N=T[y+0],R=T[y+1],w=T[y+2];u.push(N,R,R,w,w,N)}}else if(_!==void 0){const T=_.array;M=_.version;for(let y=0,E=T.length/3-1;y<E;y+=3){const N=y+0,R=y+1,w=y+2;u.push(N,R,R,w,w,N)}}else return;const f=new(sc(u)?dc:cc)(u,1);f.version=M;const h=r.get(p);h&&e.remove(h),r.set(p,f)}function d(p){const u=r.get(p);if(u){const m=p.index;m!==null&&u.version<m.version&&c(p)}else c(p);return r.get(p)}return{get:a,update:l,getWireframeAttribute:d}}function sp(n,e,t){let i;function s(u){i=u}let r,o;function a(u){r=u.type,o=u.bytesPerElement}function l(u,m){n.drawElements(i,m,r,u*o),t.update(m,i,1)}function c(u,m,_){_!==0&&(n.drawElementsInstanced(i,m,r,u*o,_),t.update(m,i,_))}function d(u,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,r,u,0,_);let f=0;for(let h=0;h<_;h++)f+=m[h];t.update(f,i,1)}function p(u,m,_,M){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let h=0;h<u.length;h++)c(u[h]/o,m[h],M[h]);else{f.multiDrawElementsInstancedWEBGL(i,m,0,r,u,0,M,0,_);let h=0;for(let T=0;T<_;T++)h+=m[T];for(let T=0;T<M.length;T++)t.update(h,i,M[T])}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=p}function rp(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(r/3);break;case n.LINES:t.lines+=a*(r/2);break;case n.LINE_STRIP:t.lines+=a*(r-1);break;case n.LINE_LOOP:t.lines+=a*r;break;case n.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function ap(n,e,t){const i=new WeakMap,s=new it;function r(o,a,l){const c=o.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,p=d!==void 0?d.length:0;let u=i.get(a);if(u===void 0||u.count!==p){let P=function(){w.dispose(),i.delete(a),a.removeEventListener("dispose",P)};u!==void 0&&u.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,M=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],h=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let y=0;m===!0&&(y=1),_===!0&&(y=2),M===!0&&(y=3);let E=a.attributes.position.count*y,N=1;E>e.maxTextureSize&&(N=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const R=new Float32Array(E*N*4*p),w=new ac(R,E,N,p);w.type=nn,w.needsUpdate=!0;const z=y*4;for(let g=0;g<p;g++){const S=f[g],W=h[g],V=T[g],q=E*N*4*g;for(let Z=0;Z<S.count;Z++){const A=Z*z;m===!0&&(s.fromBufferAttribute(S,Z),R[q+A+0]=s.x,R[q+A+1]=s.y,R[q+A+2]=s.z,R[q+A+3]=0),_===!0&&(s.fromBufferAttribute(W,Z),R[q+A+4]=s.x,R[q+A+5]=s.y,R[q+A+6]=s.z,R[q+A+7]=0),M===!0&&(s.fromBufferAttribute(V,Z),R[q+A+8]=s.x,R[q+A+9]=s.y,R[q+A+10]=s.z,R[q+A+11]=V.itemSize===4?s.w:1)}}u={count:p,texture:w,size:new We(E,N)},i.set(a,u),a.addEventListener("dispose",P)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let m=0;for(let M=0;M<c.length;M++)m+=c[M];const _=a.morphTargetsRelative?1:1-m;l.getUniforms().setValue(n,"morphTargetBaseInfluence",_),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",u.size)}return{update:r}}function op(n,e,t,i){let s=new WeakMap;function r(l){const c=i.render.frame,d=l.geometry,p=e.get(l,d);if(s.get(p)!==c&&(e.update(p),s.set(p,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const u=l.skeleton;s.get(u)!==c&&(u.update(),s.set(u,c))}return p}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}class gc extends xt{constructor(e,t,i,s,r,o,a,l,c,d=Ti){if(d!==Ti&&d!==Ii)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&d===Ti&&(i=Jn),i===void 0&&d===Ii&&(i=Di),super(null,s,r,o,a,l,d,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Tt,this.minFilter=l!==void 0?l:Tt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const _c=new xt,rl=new gc(1,1),vc=new ac,xc=new $d,Mc=new fc,al=[],ol=[],ll=new Float32Array(16),cl=new Float32Array(9),dl=new Float32Array(4);function ki(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=al[s];if(r===void 0&&(r=new Float32Array(s),al[s]=r),e!==0){i.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(r,a)}return r}function lt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ct(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function dr(n,e){let t=ol[e];t===void 0&&(t=new Int32Array(e),ol[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function lp(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function cp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2fv(this.addr,e),ct(t,e)}}function dp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(lt(t,e))return;n.uniform3fv(this.addr,e),ct(t,e)}}function up(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4fv(this.addr,e),ct(t,e)}}function hp(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,i))return;dl.set(i),n.uniformMatrix2fv(this.addr,!1,dl),ct(t,i)}}function fp(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,i))return;cl.set(i),n.uniformMatrix3fv(this.addr,!1,cl),ct(t,i)}}function pp(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,i))return;ll.set(i),n.uniformMatrix4fv(this.addr,!1,ll),ct(t,i)}}function mp(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function gp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2iv(this.addr,e),ct(t,e)}}function _p(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;n.uniform3iv(this.addr,e),ct(t,e)}}function vp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4iv(this.addr,e),ct(t,e)}}function xp(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Mp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;n.uniform2uiv(this.addr,e),ct(t,e)}}function Sp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;n.uniform3uiv(this.addr,e),ct(t,e)}}function yp(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;n.uniform4uiv(this.addr,e),ct(t,e)}}function Ep(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(rl.compareFunction=ic,r=rl):r=_c,t.setTexture2D(e||r,s)}function bp(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||xc,s)}function Tp(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||Mc,s)}function Ap(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||vc,s)}function wp(n){switch(n){case 5126:return lp;case 35664:return cp;case 35665:return dp;case 35666:return up;case 35674:return hp;case 35675:return fp;case 35676:return pp;case 5124:case 35670:return mp;case 35667:case 35671:return gp;case 35668:case 35672:return _p;case 35669:case 35673:return vp;case 5125:return xp;case 36294:return Mp;case 36295:return Sp;case 36296:return yp;case 35678:case 36198:case 36298:case 36306:case 35682:return Ep;case 35679:case 36299:case 36307:return bp;case 35680:case 36300:case 36308:case 36293:return Tp;case 36289:case 36303:case 36311:case 36292:return Ap}}function Rp(n,e){n.uniform1fv(this.addr,e)}function Cp(n,e){const t=ki(e,this.size,2);n.uniform2fv(this.addr,t)}function Lp(n,e){const t=ki(e,this.size,3);n.uniform3fv(this.addr,t)}function Pp(n,e){const t=ki(e,this.size,4);n.uniform4fv(this.addr,t)}function Dp(n,e){const t=ki(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Ip(n,e){const t=ki(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Up(n,e){const t=ki(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Np(n,e){n.uniform1iv(this.addr,e)}function Fp(n,e){n.uniform2iv(this.addr,e)}function Op(n,e){n.uniform3iv(this.addr,e)}function Bp(n,e){n.uniform4iv(this.addr,e)}function kp(n,e){n.uniform1uiv(this.addr,e)}function zp(n,e){n.uniform2uiv(this.addr,e)}function Hp(n,e){n.uniform3uiv(this.addr,e)}function Gp(n,e){n.uniform4uiv(this.addr,e)}function Vp(n,e,t){const i=this.cache,s=e.length,r=dr(t,s);lt(i,r)||(n.uniform1iv(this.addr,r),ct(i,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||_c,r[o])}function Wp(n,e,t){const i=this.cache,s=e.length,r=dr(t,s);lt(i,r)||(n.uniform1iv(this.addr,r),ct(i,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||xc,r[o])}function Xp(n,e,t){const i=this.cache,s=e.length,r=dr(t,s);lt(i,r)||(n.uniform1iv(this.addr,r),ct(i,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||Mc,r[o])}function $p(n,e,t){const i=this.cache,s=e.length,r=dr(t,s);lt(i,r)||(n.uniform1iv(this.addr,r),ct(i,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||vc,r[o])}function qp(n){switch(n){case 5126:return Rp;case 35664:return Cp;case 35665:return Lp;case 35666:return Pp;case 35674:return Dp;case 35675:return Ip;case 35676:return Up;case 5124:case 35670:return Np;case 35667:case 35671:return Fp;case 35668:case 35672:return Op;case 35669:case 35673:return Bp;case 5125:return kp;case 36294:return zp;case 36295:return Hp;case 36296:return Gp;case 35678:case 36198:case 36298:case 36306:case 35682:return Vp;case 35679:case 36299:case 36307:return Wp;case 35680:case 36300:case 36308:case 36293:return Xp;case 36289:case 36303:case 36311:case 36292:return $p}}class Yp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=wp(t.type)}}class Kp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=qp(t.type)}}class jp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],i)}}}const $r=/(\w+)(\])?(\[|\.)?/g;function ul(n,e){n.seq.push(e),n.map[e.id]=e}function Zp(n,e,t){const i=n.name,s=i.length;for($r.lastIndex=0;;){const r=$r.exec(i),o=$r.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){ul(t,c===void 0?new Yp(a,n,e):new Kp(a,n,e));break}else{let p=t.map[a];p===void 0&&(p=new jp(a),ul(t,p)),t=p}}}class qs{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);Zp(r,o,this)}}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&i.push(o)}return i}}function hl(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Jp=37297;let Qp=0;function em(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}function tm(n){const e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(n);let i;switch(e===t?i="":e===Qs&&t===Js?i="LinearDisplayP3ToLinearSRGB":e===Js&&t===Qs&&(i="LinearSRGBToLinearDisplayP3"),n){case Fn:case lr:return[i,"LinearTransferOETF"];case Qt:case oo:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function fl(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=n.getShaderInfoLog(e).trim();if(i&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+em(n.getShaderSource(e),o)}else return s}function nm(n,e){const t=tm(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function im(n,e){let t;switch(e){case vd:t="Linear";break;case xd:t="Reinhard";break;case Md:t="Cineon";break;case Sd:t="ACESFilmic";break;case Ed:t="AgX";break;case bd:t="Neutral";break;case yd:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Us=new B;function sm(){qe.getLuminanceCoefficients(Us);const n=Us.x.toFixed(4),e=Us.y.toFixed(4),t=Us.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function fm(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Xl?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Zc?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===hn&&(e="SHADOWMAP_TYPE_VSM"),e}function pm(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Li:case Pi:e="ENVMAP_TYPE_CUBE";break;case or:e="ENVMAP_TYPE_CUBE_UV";break}return e}function mm(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Pi:e="ENVMAP_MODE_REFRACTION";break}return e}function gm(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Qa:e="ENVMAP_BLENDING_MULTIPLY";break;case gd:e="ENVMAP_BLENDING_MIX";break;case _d:e="ENVMAP_BLENDING_ADD";break}return e}function _m(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function vm(n,e,t,i){const s=n.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=fm(t),c=pm(t),d=mm(t),p=gm(t),u=_m(t),m=rm(t),_=am(r),M=s.createProgram();let f,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      </g>`)}t.innerHTML=y.join(""),t.querySelectorAll(".tn").forEach(E=>{E.style.cursor="pointer",E.addEventListener("click",()=>{const N=E.dataset.id,R=f.find(w=>w.n.id===N);R?.n.children?.length&&!r&&(a.has(N)?a.delete(N):a.add(N)),l=N,i?.(E.dataset.node||null,R?.n??null),_()})})}const M=f=>f.replace(/[<>&]/g,h=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[h]);return d(),_(),{setMode(f){s=f,l=null,d(),_()},setQuery(f){r=f.trim().toLowerCase(),_()},setWip(f){c=f??new Map,_()},expandAll(){a=new Set,_()},collapseAll(){d(),_()},counts(){return{nodes:Wa(o)}}}}const bg=["LIVE","ALWAYS_ON","DARK","MIGRATED","NEEDS_CHECK"],Ul=["system","rung","phase","flag","table","function","migration"],gt=n=>String(n).replace(/[<>&"]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;"})[e]);function Tg({graph:n,status:e,mount:t,onSelect:i}){let s="",r=null,o=new Map;const a=new Map(n.nodes.map(P=>[P.id,P])),l=n.jobs??[],c=P=>e.get(P)??Ee.NEEDS_CHECK,d=P=>{const g=P.map(S=>c(S).key);return Ee[bg.find(S=>g.includes(S))??"NEEDS_CHECK"]},p=n.nodes.filter(P=>P.kind==="migration").sort((P,g)=>P.addedAt&&g.addedAt?P.addedAt.localeCompare(g.addedAt)||P.stamp.localeCompare(g.stamp):P.addedAt!==g.addedAt?P.addedAt?-1:1:(P.seq??0)-(g.seq??0)||P.stamp.localeCompare(g.stamp)),u=[];for(const P of p){const g=P.addedAt?P.addedAt.slice(0,10):"not yet committed";u.at(-1)?.day===g?u.at(-1).migs.push(P):u.push({day:g,migs:[P]})}const m=new Map;for(const P of n.edges)P.type==="delivered-by"&&(m.has(P.source)||m.set(P.source,[]),m.get(P.source).push(P.target));const _=n.nodes.filter(P=>P.kind==="phase"&&!P.planned).map(P=>{const g=(m.get(P.id)??[]).map(W=>a.get(W)).filter(Boolean),S=g.map(W=>W.addedAt).filter(Boolean).sort();return{p:P,migCount:g.length,first:S[0]?.slice(0,10)??null}}).sort((P,g)=>P.first&&g.first?P.first.localeCompare(g.first)||P.p.label.localeCompare(g.p.label):P.first!==g.first?P.first?-1:1:P.p.label.localeCompare(g.p.label)),M=Ul.map(P=>{const g=n.nodes.filter(S=>S.kind===P);return{kind:P,live:g.filter(S=>c(S.id).key==="LIVE").length,on:g.filter(S=>c(S.id).key==="ALWAYS_ON").length}}).filter(P=>P.live||P.on),f=n.nodes.filter(P=>P.kind==="flag"&&c(P.id).key==="LIVE").sort((P,g)=>P.label.localeCompare(g.label)),h=n.nodes.filter(P=>c(P.id).key==="MIGRATED"),T=n.nodes.filter(P=>c(P.id).key==="NEEDS_CHECK").length,y=n.nodes.some(P=>["LIVE","ALWAYS_ON","DARK","MIGRATED"].includes(c(P.id).key)),E=new Map;for(const P of n.edges)P.type==="flips"&&(E.has(P.source)||E.set(P.source,[]),E.get(P.source).push(P.target));const N=n.nodes.filter(P=>P.kind==="rung").sort((P,g)=>P.order-g.order),R=P=>{const g=P.label.match(/—\s*S(\d+)/);if(g)return+g[1];const S=P.label.match(/^P(\d+)/);return S?100+ +S[1]:50},w=n.nodes.filter(P=>P.kind==="phase"&&P.planned).sort((P,g)=>R(P)-R(g)||P.label.localeCompare(g.label));function z(){const P=U=>s&&!U.toLowerCase().includes(s)?" dm":"",g=U=>U===r?" sel":"",S=U=>`<span class="tl-chip" style="background:${U.hex}22;color:${U.hex}">
      ...
      <section class="tl-sec">
        ...
        ${Ue}
      </section>`,o.size)for(const U of t.querySelectorAll("[data-goto]")){const $=o.get(U.dataset.goto);$&&(U.classList.add("wip"),U.style.setProperty("--wc",$))}}return t.addEventListener("click",P=>{const g=P.target.closest("[data-goto]");!g||!t.contains(g)||(r=g.dataset.goto,i?.(r),z())}),z(),{setQuery(P){s=P.trim().toLowerCase(),z()},setWip(P){o=P??new Map,z()}}}const jr=n=>String(n).replace(/[<>&"]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;"})[e]);function Ag({graph:n,status:e,mount:t,onSelect:i}){let s="",r=null;const o=new Map(n.nodes.map(p=>[p.id,p])),a=p=>e.get(p)??Ee.NEEDS_CHECK,l=p=>o.has(p);function c(p,u){if(!l(p))return`<span class="mth-missing" title="not found in the scanned graph">${jr(u??p)}</span>`;const m=o.get(p),_=a(p),M=u??m.label,f=p===r?" sel":"",h=s&&!M.toLowerCase().includes(s)&&!m.label.toLowerCase().includes(s)?" dm":"";return`<span class="tl-fchip${f}${h}" data-goto="${jr(p)}"
      ...
      </section>`}return t.addEventListener("click",p=>{const u=p.target.closest("[data-goto]");!u||!t.contains(u)||(r=u.dataset.goto,i?.(r),d())}),d(),{setQuery(p){s=p.trim().toLowerCase(),d()}}}const Nl=(n,e,t)=>{const i=n.get(e)??[];i.push(t),n.set(e,i)},Zr=n=>n&&n.length?n.slice().sort()[0]:null;function wg(n){const e=new Map(n.nodes.map(l=>[l.id,l])),t=l=>l?.addedAt?l.addedAt.slice(0,10):null,i=new Map;for(const l of n.nodes)l.kind==="migration"&&i.set(l.id,t(l));const s=new Map,r=new Map;for(const l of n.edges){const c=t(e.get(l.source));c&&(l.type==="creates"?Nl(s,l.target,c):l.type==="seeds"&&Nl(r,l.target,c))}for(const l of n.nodes)i.get(l.id)||(l.kind==="function"||l.kind==="table"?i.set(l.id,Zr(s.get(l.id))):l.kind==="flag"&&i.set(l.id,Zr(r.get(l.id))));for(const l of n.nodes){if(l.kind!=="system")continue;const c=n.edges.filter(d=>d.type==="owned-by"&&d.target===l.id).map(d=>i.get(d.source)).filter(Boolean);i.set(l.id,Zr(c))}const o=[...new Set([...i.values()].filter(Boolean))].sort(),a=o[o.length-1]??null;for(const l of n.nodes)i.get(l.id)||i.set(l.id,a);return{birth:i,days:o}}const Xa={system:5.2,rung:4.6,phase:4.2,flag:3.4,table:2.4,migration:1.7,function:1.3},Ec=["creates","supersedes","extends","alters","drops","seeds","gated-by","calls","touches","owned-by","delivers","delivered-by","flips","waits-on"],Rg={creates:"migration defines a function/table",supersedes:"migration re-creates a function an earlier one defined",extends:"migration alters a table an earlier one created",alters:"migration changes a table",drops:"migration removes a function",seeds:"migration inserts a game_config flag","gated-by":"migration reads a flag to gate behaviour",calls:"function calls another function",touches:"function reads/writes a table","owned-by":"table belongs to a system (sole writer)",delivers:"a plan slice delivers this feature gate","delivered-by":"a plan slice was delivered by this migration",flips:"an activation rung flips this flag","waits-on":"this rung waits on the one before it"},Qi="./",[ht,Tn,bc,Cg]=await Promise.all([fetch(`${Qi}graph.json`).then(n=>n.json()),fetch(`${Qi}live.json`).then(n=>n.json()).catch(()=>null),fetch(`${Qi}wip.json`).then(n=>n.json()).catch(()=>null),fetch(`${Qi}purpose.json`).then(n=>n.json()).catch(()=>null)]),Lg=Cg?.purpose??{},Tc=n=>Lg[n]||"",{status:jt,why:Pg,frontier:Fl}=pg(ht,Tn),{birth:sr,days:Dg}=wg(ht),go=new Map(ht.nodes.map(n=>[n.id,n])),$a=new Map;for(const n of ht.edges){if(n.type!=="creates"&&n.type!=="seeds")continue;const e=go.get(n.source)?.stamp;if(!e)continue;const t=$a.get(n.target);(!t||e<t)&&$a.set(n.target,e)}const Ol={migration:0,flag:1,table:2,function:3,system:4,phase:5,rung:6},Bl=n=>(n.kind==="migration"?n.stamp:$a.get(n.id))??"99999999999999",Kn=ht.nodes.slice().sort((n,e)=>{const t=sr.get(n.id),i=sr.get(e.id);if(t!==i)return t<i?-1:1;const s=Bl(n),r=Bl(e);if(s!==r)return s<r?-1:1;const o=Ol[n.kind]??9,a=Ol[e.kind]??9;return o!==a?o-a:n.id<e.id?-1:1}).map(n=>n.id),Ig=new Map(Kn.map((n,e)=>[n,e])),us=Kn.length-1,Ht=ug(ht.nodes,ht.edges),Nn=new Map(Ht.map(n=>[n.id,n])),Ac=new Map(Ht.map((n,e)=>[n.id,e])),wn=new Map;for(const n of ht.edges)wn.has(n.source)||wn.set(n.source,[]),wn.has(n.target)||wn.set(n.target,[]),wn.get(n.source).push({...n,dir:"out",other:n.target}),wn.get(n.target).push({...n,dir:"in",other:n.source});const Ni=document.getElementById("scene"),_o=new Zm({canvas:Ni,antialias:!0});_o.setPixelRatio(Math.min(devicePixelRatio,2));const zi=new Jm;zi.fog=new fo(461071,.0016);const mn=new Bt(58,1,1,6e3);zi.add(new lg(16777215,1.5));const wc=new og(16777215,1.1);wc.position.set(1,1,1);zi.add(wc);const Ug=new po(1,14,10),Ng=new sg({transparent:!0}),ot=new tg(Ug,Ng,Ht.length);ot.instanceColor=new Ha(new Float32Array(Ht.length*3),3);zi.add(ot);const Ft=new ut,kt=new Float32Array(Ht.length*3);Ht.forEach((n,e)=>{const t=new Ie(jt.get(n.id).color);kt[e*3]=t.r,kt[e*3+1]=t.g,kt[e*3+2]=t.b});const as=new rn,Rn=new Float32Array(ht.edges.length*6),Ys=new Float32Array(ht.edges.length*6);ht.edges.forEach((n,e)=>{const t=Nn.get(n.source),i=Nn.get(n.target);Rn.set([t.x,t.y,t.z,i.x,i.y,i.z],e*6)});as.setAttribute("position",new It(Rn,3));as.setAttribute("color",new It(Ys,3));const Fg=new ig(as,new Sc({vertexColors:!0,transparent:!0,opacity:.3,depthWrite:!1,blending:Qr}));zi.add(Fg);const tt={status:new Set(mo),kind:new Set(["system","rung","phase","flag","table","migration","function"]),edge:new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),query:"",selected:null};let ts=[],Rc=new Set;const rr=new Map;let qa=[];const Si=new Map;let jn="map",tn=null,ns=null,Ya=null;const Ke={on:!1,playing:!1,i:Dg.length-1,last:0},Og=200,kl=560,Bg=n=>!tt.query||n.label.toLowerCase().includes(tt.query)||(n.detail??"").toLowerCase().includes(tt.query);function Zn(n){return Ke.on&&Ig.get(n.id)>Ke.i?!1:tt.status.has(jt.get(n.id).key)&&tt.kind.has(n.kind)&&Bg(n)}function _n(){const n=tt.selected,e=n?new Set([n,...(wn.get(n)??[]).map(s=>s.other)]):null;let t=0;Ht.forEach((s,r)=>{const o=Zn(s);o&&t++;const a=e&&!e.has(s.id),l=o?Xa[s.kind]*(s.id===n?2.1:1)*(Rc.has(s.id)?1.7:1):0;Ft.position.set(s.x,s.y,s.z),Ft.scale.setScalar(o?a?l*.55:l:0),Ft.updateMatrix(),ot.setMatrixAt(r,Ft.matrix);const c=a?.22:1;ot.instanceColor.array[r*3]=kt[r*3]*c,ot.instanceColor.array[r*3+1]=kt[r*3+1]*c,ot.instanceColor.array[r*3+2]=kt[r*3+2]*c}),ot.instanceMatrix.needsUpdate=!0,ot.instanceColor.needsUpdate=!0;let i=0;ht.edges.forEach((s,r)=>{const o=Nn.get(s.source),a=Nn.get(s.target),l=tt.edge.has(s.type)&&Zn(o)&&Zn(a)&&(!e||e.has(s.source)&&e.has(s.target));l&&i++;const c=l?new Ie(jt.get(s.source).color):null;for(let d=0;d<2;d++){const p=r*6+d*3;if(Ys[p]=c?c.r:0,Ys[p+1]=c?c.g:0,Ys[p+2]=c?c.b:0,!l)Rn[p]=0,Rn[p+1]=0,Rn[p+2]=0;else{const u=d===0?o:a;Rn[p]=u.x,Rn[p+1]=u.y,Rn[p+2]=u.z}}}),as.attributes.position.needsUpdate=!0,as.attributes.color.needsUpdate=!0,$g(t,i)}const Cc=n=>Ht.reduce((e,t)=>(e[n(t)]=(e[n(t)]??0)+1,e),{}),kg=Cc(n=>jt.get(n.id).key),zg=Cc(n=>n.kind),Hg=ht.edges.reduce((n,e)=>(n[e.type]=(n[e.type]??0)+1,n),{});function ur({id:n,label:e,color:t,count:i,checked:s,title:r,onChange:o}){const a=document.createElement("label");return a.className="row",r&&(a.title=r),a.innerHTML=`<input type="checkbox" ${s?"checked":""}/>
    ${t?`<span class="swatch" style="background:${t}"></span>`:""}
    <span>${e}</span><span class="count">${i}</span>`,a.querySelector("input").addEventListener("change",l=>{o(l.target.checked),_n()}),a}const Gg=document.getElementById("statusFilters");for(const n of mo){const e=Ee[n];Gg.append(ur({label:e.label,color:e.hex,count:kg[n]??0,checked:!0,title:e.desc,onChange:t=>t?tt.status.add(n):tt.status.delete(n)}))}const Vg=document.getElementById("kindFilters");for(const n of["rung","phase","system","flag","table","migration","function"])Vg.append(ur({label:n,count:zg[n]??0,checked:!0,onChange:e=>e?tt.kind.add(n):tt.kind.delete(n)}));const Wg=document.getElementById("edgeFilters");for(const n of Ec)Wg.append(ur({label:n,count:Hg[n]??0,checked:tt.edge.has(n),title:Rg[n],onChange:e=>e?tt.edge.add(n):tt.edge.delete(n)}));let Ka=!1;document.getElementById("cameraOptions").append(ur({label:"Auto-rotate",count:"",checked:Ka,title:"Slowly orbit the map on its own while you are not dragging or flying",onChange:n=>{Ka=n}}));document.getElementById("search").addEventListener("input",n=>{const e=n.target.value;if(jn==="tree"){tn?.setQuery(e);return}if(jn==="timeline"){ns?.setQuery(e);return}if(jn==="method"){Ya?.setQuery(e);return}tt.query=e.trim().toLowerCase(),_n()});document.getElementById("reset").addEventListener("click",()=>{tt.status=new Set(mo),tt.kind=new Set(["rung","phase","system","flag","table","migration","function"]),tt.edge=new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),tt.query="",tt.selected=null,document.getElementById("search").value="",document.querySelectorAll("#statusFilters input, #kindFilters input").forEach(n=>{n.checked=!0}),document.querySelectorAll("#edgeFilters input").forEach((n,e)=>{n.checked=tt.edge.has(Ec[e])}),document.getElementById("inspect").classList.remove("on"),Ot.set(0,0,0),Zt=520,Cn=.7,ar=.35,_n()});const Xg=document.getElementById("subtitle");Xg.textContent=`${ht.counts.nodes} nodes · ${ht.counts.edges} connections`;function $g(n,e){const t=document.getElementById("hud"),i=Tn?.sources?.gameConfig?.ok,s=Tn?.fetchedAt?new Date(Tn.fetchedAt).toLocaleString():"—",r=Tn?.deploy?.state??"unknown",o=r!=="success";t.innerHTML=`
    ...
    <div class="rel">
      ...
      `).join("")}
    </div>`,e.querySelectorAll("[data-goto]").forEach(a=>{a.addEventListener("click",()=>wi(a.dataset.goto))})}function wi(n){if(tt.selected=n,qg(n),n){const e=Nn.get(n);Ot.set(e.x,e.y,e.z),Zt=Math.min(Zt,340)}_n()}const Jt=document.getElementById("workingNow");function Lc(n){ts=n?.items??[],Rc=new Set(ts.flatMap(e=>e.nodes)),rr.clear(),Si.clear(),qa=[];for(const e of ts){const t=e.color||"#ff2d95",i=new Ie(t);for(const s of e.nodes){Si.set(s,t);const r=Ac.get(s);r!=null&&(rr.set(r,i),qa.push({i:r,n:Ht[r],col:i}))}}Yg(n),tn?.setWip?.(Si),ns?.setWip?.(Si),_n()}function Yg(n){if(!ts.length){Jt.innerHTML='<div class="wn-head"><span>Working now</span></div><div class="wn-empty">No open pull requests — nothing in flight.</div>',Jt.classList.add("on");return}const e=n?.generatedAt?new Date(n.generatedAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"",t=ts.map(i=>{const s=i.nodes[0],r=(i.touches?.functions?.length??0)+(i.touches?.tables?.length??0),o=[i.stamp?i.stamp.slice(8):null,`#${i.pr}`,r?`${r} symbol${r===1?"":"s"}`:`${i.nodes.length} node${i.nodes.length===1?"":"s"}`].filter(Boolean).join(" · ");return`<div class="wn-item" data-node="${s}" title="Fly to it">
      <span class="wn-dot" style="background:${i.color}"></span>
      <span class="wn-body"><span class="wn-title">${i.title.replace(/</g,"&lt;")}</span>
      <span class="wn-meta">${o}</span></span></div>`}).join("");Jt.innerHTML=`<div class="wn-head"><span class="wn-live"></span><span>Working now</span><span class="wn-when">${e}</span><button class="wn-fold" title="Collapse" aria-label="Collapse">${Jt.classList.contains("folded")?"+":"–"}</button></div>${t}`,Jt.classList.add("on"),Jt.querySelector(".wn-fold")?.addEventListener("click",()=>{Jt.classList.toggle("folded"),Jt.querySelector(".wn-fold").textContent=Jt.classList.contains("folded")?"+":"–"}),Jt.querySelectorAll(".wn-item").forEach(i=>i.addEventListener("click",()=>{const s=i.getAttribute("data-node");Nn.has(s)&&wi(s)}))}let zl=bc?.generatedAt??null;Lc(bc);setInterval(async()=>{if(!document.hidden)try{const n=await fetch(`${Qi}wip.json?t=${Math.floor(performance.now())}`).then(t=>t.json()),e=n?.generatedAt??null;if(e===zl)return;zl=e,Lc(n)}catch{}},2e4);document.querySelectorAll(".fold[data-fold]").forEach(n=>{n.addEventListener("click",()=>{const e=document.getElementById(n.dataset.fold);e?.classList.toggle("folded"),n.textContent=e?.classList.contains("folded")?"+":"–"})});const ja=document.getElementById("declutter"),Pc=()=>{const n=document.body.classList.toggle("clean");ja.setAttribute("aria-pressed",String(n)),ja.title=n?"Show panels (H)":"Hide all panels (H)"};ja.addEventListener("click",Pc);addEventListener("keydown",n=>{n.key.toLowerCase()==="h"&&jn==="map"&&!Mo()&&Pc()});const Dc=document.getElementById("historyBtn"),Kg=document.getElementById("playback"),Ic=document.getElementById("pbPlay"),Za=document.getElementById("pbSlider"),jg=document.getElementById("pbLabel"),Jr=document.getElementById("pbCaption"),Zg=document.getElementById("pbSpeed");let Uc=1;Zg.addEventListener("change",n=>{Uc=parseFloat(n.target.value)||1});let yi=[];const Jg=n=>{try{return new Date(n+"T00:00:00").toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}catch{return n}},Nc=n=>n.kind==="flag"?n.label.replace(/_enabled$/,"").replace(/_/g," "):n.kind==="migration"?n.label.replace(/^(init|add|create|new|seed|make)_/i,"").replace(/_/g," "):n.label,Qg=n=>Tc(n).replace(/\s*\([^)]*\)\s*$/,"");function Fc(){if(!Ke.on){Jr.classList.remove("on");return}const n=Kn[Ke.i],e=go.get(n),t=Qg(n);Jr.classList.add("on"),Jr.innerHTML=`<div class="cap-date">${Jg(sr.get(n))}</div><div class="cap-head"><span class="cap-dot" style="background:${jt.get(n).hex}"></span><b>${Nc(e)}</b> <span class="cap-kind">${e.kind}</span></div>`+(t?`<div class="cap-row">${t}</div>`:'<div class="cap-quiet">Under-the-hood plumbing — no direct player effect.</div>')}function hr(){Za.max=String(us),Za.value=String(Ke.i);const n=go.get(Kn[Ke.i]);jg.innerHTML=`<b>${Nc(n)}</b><span class="pb-sub">${Ke.i+1} / ${Kn.length} · ${sr.get(Kn[Ke.i])}</span>`,Ic.textContent=Ke.playing?"⏸":"▶"}function vo(n,e=!1){const t=Math.max(0,Math.min(us,n));if(e&&t!==Ke.i){const i=Ac.get(Kn[t]);i!=null&&yi.push({i,t:performance.now()})}Ke.i=t,_n(),hr(),Fc()}function Oc(n){Ke.on=n,Ke.playing=!1,yi=[],document.body.classList.toggle("history",n),Dc.setAttribute("aria-pressed",String(n)),Kg.classList.toggle("on",n),Ke.i=n?0:us,_n(),n&&hr(),Fc()}function e_(){Ke.on&&(Ke.i>=us&&vo(0),Ke.playing=!Ke.playing,Ke.last=performance.now(),hr())}Dc.addEventListener("click",()=>Oc(!Ke.on));Ic.addEventListener("click",e_);Za.addEventListener("input",n=>{Ke.playing=!1,vo(+n.target.value)});addEventListener("keydown",n=>{jn!=="map"||Mo()||n.key.toLowerCase()==="p"&&Oc(!Ke.on)});const Bc=document.getElementById("menuBtn"),kc=document.getElementById("scrim");function xo(n){document.getElementById("controls").classList.toggle("open",n),kc.classList.toggle("on",n),Bc.setAttribute("aria-expanded",String(n))}Bc.addEventListener("click",()=>xo(!document.getElementById("controls").classList.contains("open")));kc.addEventListener("click",()=>xo(!1));addEventListener("keydown",n=>{n.key==="Escape"&&xo(!1)});const _i=new B(0,0,0),Ot=new B(0,0,0);let vi=520,es=.7,xi=.35,Et=null,Zt=520,Cn=.7,ar=.35;const zs=.22,_t=new Set,t_=new Set(["w","a","s","d","q","e"," ","arrowup","arrowdown","arrowleft","arrowright"]),Mo=()=>{const n=document.activeElement;return!!n&&(n.tagName==="INPUT"||n.tagName==="TEXTAREA"||n.tagName==="SELECT")};addEventListener("keydown",n=>{if(jn!=="map"||Mo())return;const e=n.key.toLowerCase();t_.has(e)&&(_t.add(e),e===" "&&n.preventDefault())});addEventListener("keyup",n=>_t.delete(n.key.toLowerCase()));addEventListener("blur",()=>_t.clear());Ni.addEventListener("contextmenu",n=>n.preventDefault());const is=new B,Hl=new B,Ks=new B;function zc(){const n=innerWidth,e=innerHeight;_o.setSize(n,e),mn.aspect=n/e,mn.updateProjectionMatrix()}addEventListener("resize",zc);zc();const Dt=new Map;let Ei=null;const Hc=()=>{const[n,e]=[...Dt.values()];return Math.hypot(n.x-e.x,n.y-e.y)};Ni.addEventListener("pointerdown",n=>{Ni.setPointerCapture?.(n.pointerId),Dt.set(n.pointerId,{x:n.clientX,y:n.clientY}),Dt.size===2?(Ei={d:Hc(),dist:Zt},Et=null):Dt.size===1&&(Et={x:n.clientX,y:n.clientY,moved:!1,pan:n.button===2||n.shiftKey})});function Gc(n){const e=Dt.size;if(Dt.delete(n.pointerId),e===1&&Et&&!Et.moved&&i_(n),Dt.size<2&&(Ei=null),Dt.size===0)Et=null;else if(Dt.size===1){const[t]=[...Dt.values()];Et={x:t.x,y:t.y,moved:!0}}}addEventListener("pointerup",Gc);addEventListener("pointercancel",Gc);addEventListener("pointermove",n=>{if(Dt.has(n.pointerId)&&Dt.set(n.pointerId,{x:n.clientX,y:n.clientY}),Dt.size===2&&Ei){const e=Hc();e>0&&Ei.d>0&&(Zt=Math.max(40,Math.min(2200,Ei.dist*(Ei.d/e))));return}if(Et){const e=n.clientX-Et.x,t=n.clientY-Et.y;if(Math.abs(e)+Math.abs(t)>4&&(Et.moved=!0),Et.pan){mn.matrixWorld.extractBasis(is,Hl,Ks);const i=Zt*.0016;Ot.addScaledVector(is,-e*i),Ot.addScaledVector(Hl,t*i)}else Cn-=e*.0034,ar=Math.max(-1.45,Math.min(1.45,ar-t*.0034));Et.x=n.clientX,Et.y=n.clientY}else n.pointerType==="mouse"&&n_(n)});const Gl=new B,Vl=new B,Wl=new An;Ni.addEventListener("wheel",n=>{n.preventDefault();let e=n.deltaY;n.deltaMode===1?e*=16:n.deltaMode===2&&(e*=400);const t=Math.max(-.2,Math.min(.2,e*.0022)),i=Math.max(40,Math.min(2200,Zt*(1+t))),s=i/Zt;if(s!==1){Ri.x=n.clientX/innerWidth*2-1,Ri.y=-(n.clientY/innerHeight)*2+1,ss.setFromCamera(Ri,mn);let r=null;for(const o of ss.intersectObject(ot))if(Zn(Ht[o.instanceId])){r=Gl.copy(o.point);break}r||(mn.getWorldDirection(Vl),Wl.setFromNormalAndCoplanarPoint(Vl,_i),r=ss.ray.intersectPlane(Wl,Gl)),r&&Ot.lerp(r,1-s)}Zt=i},{passive:!1});const ss=new cg,Ri=new We;function Vc(n){Ri.x=n.clientX/innerWidth*2-1,Ri.y=-(n.clientY/innerHeight)*2+1,ss.setFromCamera(Ri,mn);const e=ss.intersectObject(ot);for(const t of e){const i=Ht[t.instanceId];if(Zn(i))return i}return null}const Zi=document.getElementById("tip");function n_(n){const e=Vc(n);if(Ni.style.cursor=e?"pointer":"default",!e){Zi.style.display="none";return}const t=jt.get(e.id);Zi.style.display="block",Zi.style.left=`${n.clientX+13}px`,Zi.style.top=`${n.clientY+13}px`,Zi.innerHTML=`<span class="swatch" style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.hex};margin-right:6px"></span>${e.label} <span style="color:#8792ab">· ${e.kind}</span>`}function i_(n){const e=Vc(n);wi(e?e.id:null)}const js={roadmap:"The only view that looks forward. Both lists come from FULL_CAPACITY_PLAN.md: the activation ladder (§B) is the ordered flips still owed — violet means everything is deployed and it is only waiting on a human. The development queue (§C) is the slices; grey means planned with nothing built behind it.",system:"Who owns what. Systems come from the sole-writer matrix in SYSTEM_BOUNDARIES. Tables sit under their owner; a function sits under the system whose tables it touches, or — failing that — under the system whose functions it calls. Anything that fits neither is left unclassified rather than forced.",build:"Every migration in the order it landed, grouped by the day git first recorded it — the filename stamps are synthetic and would pile all 205 into one bucket. Each migration lists what it created.",feature:"Every feature gate, and the migrations that seed or read it. Sorted live first, unproven last.",timeline:"The whole arc in one view. Past — every shipped arc, the migration history behind it, and the complete build log from the dev log. Present — what production proves is live, plus the deploy frontier (merged, not yet deployed). Future — the activation ladder still owed and the planned queue.",method:"How this codebase is actually built — the no-spaghetti law, the per-slice build loop (architect → implementer → adversarial reviewer → real-Postgres proof → owner-gated deploy), the verification discipline, and the server-authoritative stance. Every citation is a real node — click one to jump to it on the map. Grounded in docs/HOW_ITS_BUILT.md."};function Wc(n){jn=n,document.body.className=n,document.getElementById("treeWrap").classList.toggle("on",n==="tree"),document.getElementById("timelineWrap").classList.toggle("on",n==="timeline"),document.getElementById("methodWrap").classList.toggle("on",n==="method"),document.getElementById("scene").style.display=n==="map"?"block":"none",document.querySelectorAll("#tabs button").forEach(t=>t.classList.toggle("on",t.dataset.tab===n));const e=document.getElementById("search");if(e.value="",e.placeholder=n==="tree"?"Search the tree…":n==="timeline"?"Search the timeline…":n==="method"?"Search the method…":"Search nodes…",n==="tree"){const t=!tn;tn??=Eg({graph:ht,status:jt,svg:document.getElementById("tree"),onSelect:(i,s)=>{if(i)return wi(i);const r=document.getElementById("inspect");r.classList.add("on"),r.innerHTML=`<div class="kind">${s?.kind??"group"}</div>
          <h3>${s?.label??""}</h3>
          ...
          <div class="det">${s?.total??0} item(s) beneath this.</div>`}}),t?(tn.setMode(document.getElementById("treeMode").value),tn.setWip(Si)):tn.setQuery("")}else n==="timeline"?(ns??=Tg({graph:ht,status:jt,mount:document.getElementById("timeline"),onSelect:t=>wi(t)}),ns.setWip(Si),ns.setQuery("")):n==="method"?(Ya??=Ag({graph:ht,status:jt,mount:document.getElementById("method"),onSelect:t=>wi(t)}),Ya.setQuery("")):(tt.query="",_n());document.getElementById("treeHint").textContent=js[document.getElementById("treeMode").value],document.getElementById("timelineHint").textContent=js.timeline,document.getElementById("methodHint").textContent=js.method}document.querySelectorAll("#tabs button").forEach(n=>{n.addEventListener("click",()=>Wc(n.dataset.tab))});document.getElementById("treeMode").addEventListener("change",n=>{tn?.setMode(n.target.value),document.getElementById("treeHint").textContent=js[n.target.value]});document.getElementById("expandAll").addEventListener("click",()=>tn?.expandAll());document.getElementById("collapseAll").addEventListener("click",()=>tn?.collapseAll());window.__cam=()=>({dist:vi,yaw:es,pitch:xi});document.getElementById("loading").remove();Wc("map");_n();(function n(){if(requestAnimationFrame(n),_t.size){const e=Zt*.012;Ks.set(-Math.sin(Cn),0,-Math.cos(Cn)),is.set(Math.cos(Cn),0,-Math.sin(Cn)),(_t.has("w")||_t.has("arrowup"))&&Ot.addScaledVector(Ks,e),(_t.has("s")||_t.has("arrowdown"))&&Ot.addScaledVector(Ks,-e),(_t.has("d")||_t.has("arrowright"))&&Ot.addScaledVector(is,e),(_t.has("a")||_t.has("arrowleft"))&&Ot.addScaledVector(is,-e),(_t.has("e")||_t.has(" "))&&(Ot.y+=e),_t.has("q")&&(Ot.y-=e)}if(Ka&&!Et&&!_t.size&&(Cn+=4e-4),es+=(Cn-es)*zs,xi+=(ar-xi)*zs,vi+=(Zt-vi)*zs,_i.lerp(Ot,zs),mn.position.set(_i.x+vi*Math.cos(xi)*Math.sin(es),_i.y+vi*Math.sin(xi),_i.z+vi*Math.cos(xi)*Math.cos(es)),mn.lookAt(_i),rr.size){const e=.5+.5*Math.sin(performance.now()*.0075),t=e*e,i=.25+.75*t,s=ot.instanceColor.array;for(const[o,a]of rr){const l=o*3;s[l]=kt[l]*(1-i)+Math.min(1,a.r*2+.15)*i,s[l+1]=kt[l+1]*(1-i)+Math.min(1,a.g*2+.15)*i,s[l+2]=kt[l+2]*(1-i)+Math.min(1,a.b*2+.15)*i}ot.instanceColor.needsUpdate=!0;const r=1+1.1*t;for(const{i:o,n:a}of qa){if(!Zn(a))continue;const l=Xa[a.kind]*1.7*r;Ft.position.set(a.x,a.y,a.z),Ft.scale.setScalar(l),Ft.updateMatrix(),ot.setMatrixAt(o,Ft.matrix)}ot.instanceMatrix.needsUpdate=!0}if(Ke.on&&Ke.playing){const e=performance.now();e-Ke.last>=Og/Uc&&(Ke.last=e,Ke.i>=us?(Ke.playing=!1,hr()):vo(Ke.i+1,!0))}if(yi.length){const e=performance.now();yi=yi.filter(t=>e-t.t<kl);for(const t of yi){const i=Ht[t.i];if(!Zn(i))continue;const s=(e-t.t)/kl,r=1+1.6*(1-s);Ft.position.set(i.x,i.y,i.z),Ft.scale.setScalar(Xa[i.kind]*r),Ft.updateMatrix(),ot.setMatrixAt(t.i,Ft.matrix);const o=t.i*3,a=1-s;ot.instanceColor.array[o]=kt[o]*(1-a)+a,ot.instanceColor.array[o+1]=kt[o+1]*(1-a)+a,ot.instanceColor.array[o+2]=kt[o+2]*(1-a)+a}ot.instanceMatrix.needsUpdate=!0,ot.instanceColor.needsUpdate=!0}_o.render(zi,mn)})();
