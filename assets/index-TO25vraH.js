...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Uo(){return new Cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function No(){return new Cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xa(),fragmentShader:`
	...
	`}function gf(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,u=l===qs||l===Ys,c=l===Mi||l===Si;if(u||c){let p=e.get(a);const d=p!==void 0?p.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new Do(i)),p=u?t.fromEquirectangular(a,p):t.fromCubemap(a,p),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),p.texture;if(p!==void 0)return p.texture;{const m=a.image;return u&&m&&m.height>0||c&&m&&r(m)?(t===null&&(t=new Do(i)),p=u?t.fromEquirectangular(a):t.fromCubemap(a),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),a.addEventListener("dispose",s),p.texture):null}}}return a}function r(a){let l=0;const u=6;for(let c=0;c<u;c++)a[c]!==void 0&&l++;return l===u}function s(a){const l=a.target;l.removeEventListener("dispose",s);const u=e.get(l);u!==void 0&&(e.delete(l),u.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function _f(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Nr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function vf(i,e,t,n){const r={},s=new WeakMap;function o(p){const d=p.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);for(const _ in d.morphAttributes){const x=d.morphAttributes[_];for(let f=0,h=x.length;f<h;f++)e.remove(x[f])}d.removeEventListener("dispose",o),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(p,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(p){const d=p.attributes;for(const _ in d)e.update(d[_],i.ARRAY_BUFFER);const m=p.morphAttributes;for(const _ in m){const x=m[_];for(let f=0,h=x.length;f<h;f++)e.update(x[f],i.ARRAY_BUFFER)}}function u(p){const d=[],m=p.index,_=p.attributes.position;let x=0;if(m!==null){const T=m.array;x=m.version;for(let S=0,b=T.length;S<b;S+=3){const U=T[S+0],C=T[S+1],R=T[S+2];d.push(U,C,C,R,R,U)}}else if(_!==void 0){const T=_.array;x=_.version;for(let S=0,b=T.length/3-1;S<b;S+=3){const U=S+0,C=S+1,R=S+2;d.push(U,C,C,R,R,U)}}else return;const f=new(Ll(d)?Ol:Fl)(d,1);f.version=x;const h=s.get(p);h&&e.remove(h),s.set(p,f)}function c(p){const d=s.get(p);if(d){const m=p.index;m!==null&&d.version<m.version&&u(p)}else u(p);return s.get(p)}return{get:a,update:l,getWireframeAttribute:c}}function xf(i,e,t){let n;function r(d){n=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,m){i.drawElements(n,m,s,d*o),t.update(m,n,1)}function u(d,m,_){_!==0&&(i.drawElementsInstanced(n,m,s,d*o,_),t.update(m,n,_))}function c(d,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,d,0,_);let f=0;for(let h=0;h<_;h++)f+=m[h];t.update(f,n,1)}function p(d,m,_,x){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let h=0;h<d.length;h++)u(d[h]/o,m[h],x[h]);else{f.multiDrawElementsInstancedWEBGL(n,m,0,s,d,0,x,0,_);let h=0;for(let T=0;T<_;T++)h+=m[T];for(let T=0;T<x.length;T++)t.update(h,n,x[T])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=u,this.renderMultiDraw=c,this.renderMultiDrawInstances=p}function Mf(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Sf(i,e,t){const n=new WeakMap,r=new nt;function s(o,a,l){const u=o.morphTargetInfluences,c=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,p=c!==void 0?c.length:0;let d=n.get(a);if(d===void 0||d.count!==p){let G=function(){R.dispose(),n.delete(a),a.removeEventListener("dispose",G)};d!==void 0&&d.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,x=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],h=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let S=0;m===!0&&(S=1),_===!0&&(S=2),x===!0&&(S=3);let b=a.attributes.position.count*S,U=1;b>e.maxTextureSize&&(U=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const C=new Float32Array(b*U*4*p),R=new Il(C,b,U,p);R.type=Kt,R.needsUpdate=!0;const w=S*4;for(let g=0;g<p;g++){const E=f[g],X=h[g],V=T[g],$=b*U*4*g;for(let Z=0;Z<E.count;Z++){const A=Z*w;m===!0&&(r.fromBufferAttribute(E,Z),C[$+A+0]=r.x,C[$+A+1]=r.y,C[$+A+2]=r.z,C[$+A+3]=0),_===!0&&(r.fromBufferAttribute(X,Z),C[$+A+4]=r.x,C[$+A+5]=r.y,C[$+A+6]=r.z,C[$+A+7]=0),x===!0&&(r.fromBufferAttribute(V,Z),C[$+A+8]=r.x,C[$+A+9]=r.y,C[$+A+10]=r.z,C[$+A+11]=V.itemSize===4?r.w:1)}}d={count:p,texture:R,size:new Ve(b,U)},n.set(a,d),a.addEventListener("dispose",G)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let m=0;for(let x=0;x<u.length;x++)m+=u[x];const _=a.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",u)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function Ef(i,e,t,n){let r=new WeakMap;function s(l){const u=n.render.frame,c=l.geometry,p=e.get(l,c);if(r.get(p)!==u&&(e.update(p),r.set(p,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==u&&(d.update(),r.set(d,u))}return p}function o(){r=new WeakMap}function a(l){const u=l.target;u.removeEventListener("dispose",a),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:s,dispose:o}}class Vl extends gt{constructor(e,t,n,r,s,o,a,l,u,c=mi){if(c!==mi&&c!==yi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&c===mi&&(n=Vn),n===void 0&&c===yi&&(n=Ei),super(null,r,s,o,a,l,c,n,u),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Et,this.minFilter=l!==void 0?l:Et,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Wl=new gt,Fo=new Vl(1,1),Xl=new Il,$l=new ou,ql=new kl,Oo=[],Bo=[],zo=new Float32Array(16),ko=new Float32Array(9),Ho=new Float32Array(4);function Ci(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Oo[r];if(s===void 0&&(s=new Float32Array(r),Oo[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function at(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ot(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Jr(i,e){let t=Bo[e];t===void 0&&(t=new Int32Array(e),Bo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function yf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function bf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2fv(this.addr,e),ot(t,e)}}function Tf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;i.uniform3fv(this.addr,e),ot(t,e)}}function Af(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4fv(this.addr,e),ot(t,e)}}function wf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Ho.set(n),i.uniformMatrix2fv(this.addr,!1,Ho),ot(t,n)}}function Rf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;ko.set(n),i.uniformMatrix3fv(this.addr,!1,ko),ot(t,n)}}function Cf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;zo.set(n),i.uniformMatrix4fv(this.addr,!1,zo),ot(t,n)}}function Pf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Lf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2iv(this.addr,e),ot(t,e)}}function Df(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3iv(this.addr,e),ot(t,e)}}function If(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4iv(this.addr,e),ot(t,e)}}function Uf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Nf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2uiv(this.addr,e),ot(t,e)}}function Ff(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3uiv(this.addr,e),ot(t,e)}}function Of(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4uiv(this.addr,e),ot(t,e)}}function Bf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Fo.compareFunction=Pl,s=Fo):s=Wl,t.setTexture2D(e||s,r)}function zf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||$l,r)}function kf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||ql,r)}function Hf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Xl,r)}function Gf(i){switch(i){case 5126:return yf;case 35664:return bf;case 35665:return Tf;case 35666:return Af;case 35674:return wf;case 35675:return Rf;case 35676:return Cf;case 5124:case 35670:return Pf;case 35667:case 35671:return Lf;case 35668:case 35672:return Df;case 35669:case 35673:return If;case 5125:return Uf;case 36294:return Nf;case 36295:return Ff;case 36296:return Of;case 35678:case 36198:case 36298:case 36306:case 35682:return Bf;case 35679:case 36299:case 36307:return zf;case 35680:case 36300:case 36308:case 36293:return kf;case 36289:case 36303:case 36311:case 36292:return Hf}}function Vf(i,e){i.uniform1fv(this.addr,e)}function Wf(i,e){const t=Ci(e,this.size,2);i.uniform2fv(this.addr,t)}function Xf(i,e){const t=Ci(e,this.size,3);i.uniform3fv(this.addr,t)}function $f(i,e){const t=Ci(e,this.size,4);i.uniform4fv(this.addr,t)}function qf(i,e){const t=Ci(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Yf(i,e){const t=Ci(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Kf(i,e){const t=Ci(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function jf(i,e){i.uniform1iv(this.addr,e)}function Zf(i,e){i.uniform2iv(this.addr,e)}function Jf(i,e){i.uniform3iv(this.addr,e)}function Qf(i,e){i.uniform4iv(this.addr,e)}function ep(i,e){i.uniform1uiv(this.addr,e)}function tp(i,e){i.uniform2uiv(this.addr,e)}function np(i,e){i.uniform3uiv(this.addr,e)}function ip(i,e){i.uniform4uiv(this.addr,e)}function rp(i,e,t){const n=this.cache,r=e.length,s=Jr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Wl,s[o])}function sp(i,e,t){const n=this.cache,r=e.length,s=Jr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||$l,s[o])}function ap(i,e,t){const n=this.cache,r=e.length,s=Jr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||ql,s[o])}function op(i,e,t){const n=this.cache,r=e.length,s=Jr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Xl,s[o])}function lp(i){switch(i){case 5126:return Vf;case 35664:return Wf;case 35665:return Xf;case 35666:return $f;case 35674:return qf;case 35675:return Yf;case 35676:return Kf;case 5124:case 35670:return jf;case 35667:case 35671:return Zf;case 35668:case 35672:return Jf;case 35669:case 35673:return Qf;case 5125:return ep;case 36294:return tp;case 36295:return np;case 36296:return ip;case 35678:case 36198:case 36298:case 36306:case 35682:return rp;case 35679:case 36299:case 36307:return sp;case 35680:case 36300:case 36308:case 36293:return ap;case 36289:case 36303:case 36311:case 36292:return op}}class cp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Gf(t.type)}}class up{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=lp(t.type)}}class dp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Is=/(\w+)(\])?(\[|\.)?/g;function Go(i,e){i.seq.push(e),i.map[e.id]=e}function hp(i,e,t){const n=i.name,r=n.length;for(Is.lastIndex=0;;){const s=Is.exec(n),o=Is.lastIndex;let a=s[1];const l=s[2]==="]",u=s[3];if(l&&(a=a|0),u===void 0||u==="["&&o+2===r){Go(t,u===void 0?new cp(a,i,e):new up(a,i,e));break}else{let p=t.map[a];p===void 0&&(p=new dp(a),Go(t,p)),t=p}}}class Fr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);hp(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Vo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const fp=37297;let pp=0;function mp(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function gp(i){const e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(i);let n;switch(e===t?n="":e===Hr&&t===kr?n="LinearDisplayP3ToLinearSRGB":e===kr&&t===Hr&&(n="LinearSRGBToLinearDisplayP3"),i){case Pn:case jr:return[n,"LinearTransferOETF"];case $t:case Ha:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Wo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+mp(i.getShaderSource(e),o)}else return r}function _p(i,e){const t=gp(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function vp(i,e){let t;switch(e){case Ic:t="Linear";break;case Uc:t="Reinhard";break;case Nc:t="Cineon";break;case Fc:t="ACESFilmic";break;case Bc:t="AgX";break;case zc:t="Neutral";break;case Oc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Er=new O;function xp(){qe.getLuminanceCoefficients(Er);const i=Er.x.toFixed(4),e=Er.y.toFixed(4),t=Er.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Rp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===vl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===hc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(e="SHADOWMAP_TYPE_VSM"),e}function Cp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Mi:case Si:e="ENVMAP_TYPE_CUBE";break;case Kr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Pp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Si:e="ENVMAP_MODE_REFRACTION";break}return e}function Lp(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ia:e="ENVMAP_BLENDING_MULTIPLY";break;case Lc:e="ENVMAP_BLENDING_MIX";break;case Dc:e="ENVMAP_BLENDING_ADD";break}return e}function Dp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Ip(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Rp(t),u=Cp(t),c=Pp(t),p=Lp(t),d=Dp(t),m=Mp(t),_=Sp(s),x=r.createProgram();let f,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Vi).join(`
`)),o=ba(o),o=Xo(o,t),o=$o(o,t),a=ba(a),a=Xo(a,t),a=$o(a,t),o=qo(o),a=qo(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        ${C?`<text x="${wr-8}" y="${Hi/2+3.6}" font-size="9" text-anchor="end" fill="#8792ab">${R?`+${S.n.total}`:"–"}</text>`:""}
      </g>`)}t.innerHTML=T.join(""),t.querySelectorAll(".tn").forEach(S=>{S.style.cursor="pointer",S.addEventListener("click",()=>{const b=S.dataset.id,U=x.find(C=>C.n.id===b);U?.n.children?.length&&!s&&(a.has(b)?a.delete(b):a.add(b)),l=b,n?.(S.dataset.node||null,U?.n??null),m()})})}const _=x=>x.replace(/[<>&]/g,f=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[f]);return u(),m(),{setMode(x){r=x,l=null,u(),m()},setQuery(x){s=x.trim().toLowerCase(),m()},expandAll(){a=new Set,m()},collapseAll(){u(),m()},counts(){return{nodes:Ra(o)}}}}const zm=["LIVE","ALWAYS_ON","DARK","MIGRATED","NEEDS_CHECK"],dl=["system","rung","phase","flag","table","function","migration"],ft=i=>String(i).replace(/[<>&"]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;"})[e]);function km({graph:i,status:e,mount:t,onSelect:n}){let r="",s=null;const o=new Map(i.nodes.map(w=>[w.id,w])),a=i.jobs??[],l=w=>e.get(w)??be.NEEDS_CHECK,u=w=>{const G=w.map(g=>l(g).key);return be[zm.find(g=>G.includes(g))??"NEEDS_CHECK"]},c=i.nodes.filter(w=>w.kind==="migration").sort((w,G)=>w.addedAt&&G.addedAt?w.addedAt.localeCompare(G.addedAt)||w.stamp.localeCompare(G.stamp):w.addedAt!==G.addedAt?w.addedAt?-1:1:(w.seq??0)-(G.seq??0)||w.stamp.localeCompare(G.stamp)),p=[];for(const w of c){const G=w.addedAt?w.addedAt.slice(0,10):"not yet committed";p.at(-1)?.day===G?p.at(-1).migs.push(w):p.push({day:G,migs:[w]})}const d=new Map;for(const w of i.edges)w.type==="delivered-by"&&(d.has(w.source)||d.set(w.source,[]),d.get(w.source).push(w.target));const m=i.nodes.filter(w=>w.kind==="phase"&&!w.planned).map(w=>{const G=(d.get(w.id)??[]).map(E=>o.get(E)).filter(Boolean),g=G.map(E=>E.addedAt).filter(Boolean).sort();return{p:w,migCount:G.length,first:g[0]?.slice(0,10)??null}}).sort((w,G)=>w.first&&G.first?w.first.localeCompare(G.first)||w.p.label.localeCompare(G.p.label):w.first!==G.first?w.first?-1:1:w.p.label.localeCompare(G.p.label)),_=dl.map(w=>{const G=i.nodes.filter(g=>g.kind===w);return{kind:w,live:G.filter(g=>l(g.id).key==="LIVE").length,on:G.filter(g=>l(g.id).key==="ALWAYS_ON").length}}).filter(w=>w.live||w.on),x=i.nodes.filter(w=>w.kind==="flag"&&l(w.id).key==="LIVE").sort((w,G)=>w.label.localeCompare(G.label)),f=i.nodes.filter(w=>l(w.id).key==="MIGRATED"),h=i.nodes.filter(w=>l(w.id).key==="NEEDS_CHECK").length,T=i.nodes.some(w=>["LIVE","ALWAYS_ON","DARK","MIGRATED"].includes(l(w.id).key)),S=new Map;for(const w of i.edges)w.type==="flips"&&(S.has(w.source)||S.set(w.source,[]),S.get(w.source).push(w.target));const b=i.nodes.filter(w=>w.kind==="rung").sort((w,G)=>w.order-G.order),U=w=>{const G=w.label.match(/—\s*S(\d+)/);if(G)return+G[1];const g=w.label.match(/^P(\d+)/);return g?100+ +g[1]:50},C=i.nodes.filter(w=>w.kind==="phase"&&w.planned).sort((w,G)=>U(w)-U(G)||w.label.localeCompare(G.label));function R(){const w=te=>r&&!te.toLowerCase().includes(r)?" dm":"",G=te=>te===s?" sel":"",g=te=>`<span class="tl-chip" style="background:${te.hex}22;color:${te.hex}">
      ...
      <tbody>
        ...
        <tr class="tot"><td>total</td><td>${A}</td><td>${N}</td></tr>
         ...
         <div class="tl-chips">${x.map(te=>E(te.id)).join("")}</div>`:"";let ie;T?f.length?ie=dl.map(te=>{const z=f.filter(q=>q.kind===te).sort((q,ce)=>q.label.localeCompare(ce.label));return z.length?`<div class="tl-note">${te} (${z.length})</div>
      ...
      <section class="tl-sec">
        ...
        ${Ie}
      </section>`}return t.addEventListener("click",w=>{const G=w.target.closest("[data-goto]");!G||!t.contains(G)||(s=G.dataset.goto,n?.(s),R())}),R(),{setQuery(w){r=w.trim().toLowerCase(),R()}}}const Hm={system:5.2,rung:4.6,phase:4.2,flag:3.4,table:2.4,migration:1.7,function:1.3},jl=["creates","supersedes","extends","alters","drops","seeds","gated-by","calls","touches","owned-by","delivers","delivered-by","flips","waits-on"],Gm={creates:"migration defines a function/table",supersedes:"migration re-creates a function an earlier one defined",extends:"migration alters a table an earlier one created",alters:"migration changes a table",drops:"migration removes a function",seeds:"migration inserts a game_config flag","gated-by":"migration reads a flag to gate behaviour",calls:"function calls another function",touches:"function reads/writes a table","owned-by":"table belongs to a system (sole writer)",delivers:"a plan slice delivers this feature gate","delivered-by":"a plan slice was delivered by this migration",flips:"an activation rung flips this flag","waits-on":"this rung waits on the one before it"},hl="./",[Lt,xn]=await Promise.all([fetch(`${hl}graph.json`).then(i=>i.json()),fetch(`${hl}live.json`).then(i=>i.json()).catch(()=>null)]),{status:dn,why:Vm,frontier:fl}=Cm(Lt,xn),Jt=Am(Lt.nodes,Lt.edges),Xn=new Map(Jt.map(i=>[i.id,i]));new Map(Jt.map((i,e)=>[i.id,e]));const Sn=new Map;for(const i of Lt.edges)Sn.has(i.source)||Sn.set(i.source,[]),Sn.has(i.target)||Sn.set(i.target,[]),Sn.get(i.source).push({...i,dir:"out",other:i.target}),Sn.get(i.target).push({...i,dir:"in",other:i.source});const Ti=document.getElementById("scene"),Ka=new hm({canvas:Ti,antialias:!0});Ka.setPixelRatio(Math.min(devicePixelRatio,2));const Pi=new fm;Pi.fog=new $a(461071,.0016);const cn=new Nt(58,1,1,6e3);Pi.add(new ym(16777215,1.5));const Zl=new Em(16777215,1.1);Zl.position.set(1,1,1);Pi.add(Zl);const Wm=new qa(1,14,10),Xm=new xm({transparent:!0}),Yt=new gm(Wm,Xm,Jt.length);Yt.instanceColor=new Ta(new Float32Array(Jt.length*3),3);Pi.add(Yt);const Rr=new ct,_i=new Float32Array(Jt.length*3);Jt.forEach((i,e)=>{const t=new Ne(dn.get(i.id).color);_i[e*3]=t.r,_i[e*3+1]=t.g,_i[e*3+2]=t.b});const Ki=new Zt,En=new Float32Array(Lt.edges.length*6),Or=new Float32Array(Lt.edges.length*6);Lt.edges.forEach((i,e)=>{const t=Xn.get(i.source),n=Xn.get(i.target);En.set([t.x,t.y,t.z,n.x,n.y,n.z],e*6)});Ki.setAttribute("position",new Pt(En,3));Ki.setAttribute("color",new Pt(Or,3));const $m=new vm(Ki,new Yl({vertexColors:!0,transparent:!0,opacity:.3,depthWrite:!1,blending:Os}));Pi.add($m);const et={status:new Set(Ya),kind:new Set(["system","rung","phase","flag","table","migration","function"]),edge:new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),query:"",selected:null},qm=i=>!et.query||i.label.toLowerCase().includes(et.query)||(i.detail??"").toLowerCase().includes(et.query);function Xi(i){return et.status.has(dn.get(i.id).key)&&et.kind.has(i.kind)&&qm(i)}function Li(){const i=et.selected,e=i?new Set([i,...(Sn.get(i)??[]).map(r=>r.other)]):null;let t=0;Jt.forEach((r,s)=>{const o=Xi(r);o&&t++;const a=e&&!e.has(r.id),l=o?Hm[r.kind]*(r.id===i?2.1:1):0;Rr.position.set(r.x,r.y,r.z),Rr.scale.setScalar(o?a?l*.55:l:0),Rr.updateMatrix(),Yt.setMatrixAt(s,Rr.matrix);const u=a?.22:1;Yt.instanceColor.array[s*3]=_i[s*3]*u,Yt.instanceColor.array[s*3+1]=_i[s*3+1]*u,Yt.instanceColor.array[s*3+2]=_i[s*3+2]*u}),Yt.instanceMatrix.needsUpdate=!0,Yt.instanceColor.needsUpdate=!0;let n=0;Lt.edges.forEach((r,s)=>{const o=Xn.get(r.source),a=Xn.get(r.target),l=et.edge.has(r.type)&&Xi(o)&&Xi(a)&&(!e||e.has(r.source)&&e.has(r.target));l&&n++;const u=l?new Ne(dn.get(r.source).color):null;for(let c=0;c<2;c++){const p=s*6+c*3;if(Or[p]=u?u.r:0,Or[p+1]=u?u.g:0,Or[p+2]=u?u.b:0,!l)En[p]=0,En[p+1]=0,En[p+2]=0;else{const d=c===0?o:a;En[p]=d.x,En[p+1]=d.y,En[p+2]=d.z}}}),Ki.attributes.position.needsUpdate=!0,Ki.attributes.color.needsUpdate=!0,tg(t,n)}const Jl=i=>Jt.reduce((e,t)=>(e[i(t)]=(e[i(t)]??0)+1,e),{}),Ym=Jl(i=>dn.get(i.id).key),Km=Jl(i=>i.kind),jm=Lt.edges.reduce((i,e)=>(i[e.type]=(i[e.type]??0)+1,i),{});function Qr({id:i,label:e,color:t,count:n,checked:r,title:s,onChange:o}){const a=document.createElement("label");return a.className="row",s&&(a.title=s),a.innerHTML=`<input type="checkbox" ${r?"checked":""}/>
    ${t?`<span class="swatch" style="background:${t}"></span>`:""}
    <span>${e}</span><span class="count">${n}</span>`,a.querySelector("input").addEventListener("change",l=>{o(l.target.checked),Li()}),a}const Zm=document.getElementById("statusFilters");for(const i of Ya){const e=be[i];Zm.append(Qr({label:e.label,color:e.hex,count:Ym[i]??0,checked:!0,title:e.desc,onChange:t=>t?et.status.add(i):et.status.delete(i)}))}const Jm=document.getElementById("kindFilters");for(const i of["rung","phase","system","flag","table","migration","function"])Jm.append(Qr({label:i,count:Km[i]??0,checked:!0,onChange:e=>e?et.kind.add(i):et.kind.delete(i)}));const Qm=document.getElementById("edgeFilters");for(const i of jl)Qm.append(Qr({label:i,count:jm[i]??0,checked:et.edge.has(i),title:Gm[i],onChange:e=>e?et.edge.add(i):et.edge.delete(i)}));let Ca=!1;document.getElementById("cameraOptions").append(Qr({label:"Auto-rotate",count:"",checked:Ca,title:"Slowly orbit the map on its own while you are not dragging or flying",onChange:i=>{Ca=i}}));document.getElementById("search").addEventListener("input",i=>{const e=i.target.value;if(Yr==="tree"){Tn?.setQuery(e);return}if(Yr==="timeline"){La?.setQuery(e);return}et.query=e.trim().toLowerCase(),Li()});document.getElementById("reset").addEventListener("click",()=>{et.status=new Set(Ya),et.kind=new Set(["rung","phase","system","flag","table","migration","function"]),et.edge=new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),et.query="",et.selected=null,document.getElementById("search").value="",document.querySelectorAll("#statusFilters input, #kindFilters input").forEach(i=>{i.checked=!0}),document.querySelectorAll("#edgeFilters input").forEach((i,e)=>{i.checked=et.edge.has(jl[e])}),document.getElementById("inspect").classList.remove("on"),Ut.set(0,0,0),Xt=520,yn=.7,qr=.35,Li()});const eg=document.getElementById("subtitle");eg.textContent=`${Lt.counts.nodes} nodes · ${Lt.counts.edges} connections`;function tg(i,e){const t=document.getElementById("hud"),n=xn?.sources?.gameConfig?.ok,r=xn?.fetchedAt?new Date(xn.fetchedAt).toLocaleString():"—",s=xn?.deploy?.state??"unknown",o=s!=="success";t.innerHTML=`
    ...
    <div class="why">${Vm.get(i)??""}</div>
    ${t.file?`<div class="file">${t.file}</div>`:""}
    ${t.detail?`<div class="det">${t.detail}</div>`:""}
    <div class="rel">
      ${Object.entries(s).map(([o,a])=>`
        <h4>${o} (${a.length})</h4>
        ${a.slice(0,22).map(l=>{const u=Xn.get(l.other),c=dn.get(l.other);return`<div data-goto="${l.other}">
            <span class="swatch" style="background:${c.hex}"></span>
            <span>${u.label}</span>${l.note?`<span class="t">${l.note}</span>`:""}</div>`}).join("")}
        ${a.length>22?`<div class="t">…${a.length-22} more</div>`:""}
      `).join("")}
    </div>`,e.querySelectorAll("[data-goto]").forEach(o=>{o.addEventListener("click",()=>$r(o.dataset.goto))})}function $r(i){if(et.selected=i,ng(i),i){const e=Xn.get(i);Ut.set(e.x,e.y,e.z),Xt=Math.min(Xt,340)}Li()}const Ql=document.getElementById("menuBtn"),ec=document.getElementById("scrim");function ja(i){document.getElementById("controls").classList.toggle("open",i),ec.classList.toggle("on",i),Ql.setAttribute("aria-expanded",String(i))}Ql.addEventListener("click",()=>ja(!document.getElementById("controls").classList.contains("open")));ec.addEventListener("click",()=>ja(!1));addEventListener("keydown",i=>{i.key==="Escape"&&ja(!1)});const ci=new O(0,0,0),Ut=new O(0,0,0);let ui=520,Wi=.7,di=.35,Mt=null,Xt=520,yn=.7,qr=.35;const Cr=.16,pt=new Set,ig=new Set(["w","a","s","d","q","e"," ","arrowup","arrowdown","arrowleft","arrowright"]),rg=()=>{const i=document.activeElement;return!!i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT")};addEventListener("keydown",i=>{if(Yr!=="map"||rg())return;const e=i.key.toLowerCase();ig.has(e)&&(pt.add(e),e===" "&&i.preventDefault())});addEventListener("keyup",i=>pt.delete(i.key.toLowerCase()));addEventListener("blur",()=>pt.clear());Ti.addEventListener("contextmenu",i=>i.preventDefault());const $i=new O,pl=new O,Br=new O;function tc(){const i=innerWidth,e=innerHeight;Ka.setSize(i,e),cn.aspect=i/e,cn.updateProjectionMatrix()}addEventListener("resize",tc);tc();const Ct=new Map;let fi=null;const nc=()=>{const[i,e]=[...Ct.values()];return Math.hypot(i.x-e.x,i.y-e.y)};Ti.addEventListener("pointerdown",i=>{Ti.setPointerCapture?.(i.pointerId),Ct.set(i.pointerId,{x:i.clientX,y:i.clientY}),Ct.size===2?(fi={d:nc(),dist:Xt},Mt=null):Ct.size===1&&(Mt={x:i.clientX,y:i.clientY,moved:!1,pan:i.button===2||i.shiftKey})});function ic(i){const e=Ct.size;if(Ct.delete(i.pointerId),e===1&&Mt&&!Mt.moved&&ag(i),Ct.size<2&&(fi=null),Ct.size===0)Mt=null;else if(Ct.size===1){const[t]=[...Ct.values()];Mt={x:t.x,y:t.y,moved:!0}}}addEventListener("pointerup",ic);addEventListener("pointercancel",ic);addEventListener("pointermove",i=>{if(Ct.has(i.pointerId)&&Ct.set(i.pointerId,{x:i.clientX,y:i.clientY}),Ct.size===2&&fi){const e=nc();e>0&&fi.d>0&&(Xt=Math.max(40,Math.min(2200,fi.dist*(fi.d/e))));return}if(Mt){const e=i.clientX-Mt.x,t=i.clientY-Mt.y;if(Math.abs(e)+Math.abs(t)>4&&(Mt.moved=!0),Mt.pan){cn.matrixWorld.extractBasis($i,pl,Br);const n=Xt*.0016;Ut.addScaledVector($i,-e*n),Ut.addScaledVector(pl,t*n)}else yn-=e*.005,qr=Math.max(-1.5,Math.min(1.5,qr-t*.005));Mt.x=i.clientX,Mt.y=i.clientY}else i.pointerType==="mouse"&&sg(i)});const ml=new O,gl=new O,_l=new Mn;Ti.addEventListener("wheel",i=>{i.preventDefault();let e=i.deltaY;i.deltaMode===1?e*=16:i.deltaMode===2&&(e*=400);const t=Math.max(-.2,Math.min(.2,e*.0022)),n=Math.max(40,Math.min(2200,Xt*(1+t))),r=n/Xt;if(r!==1){vi.x=i.clientX/innerWidth*2-1,vi.y=-(i.clientY/innerHeight)*2+1,qi.setFromCamera(vi,cn);let s=null;for(const o of qi.intersectObject(Yt))if(Xi(Jt[o.instanceId])){s=ml.copy(o.point);break}s||(cn.getWorldDirection(gl),_l.setFromNormalAndCoplanarPoint(gl,ci),s=qi.ray.intersectPlane(_l,ml)),s&&Ut.lerp(s,1-r)}Xt=n},{passive:!1});const qi=new bm,vi=new Ve;function rc(i){vi.x=i.clientX/innerWidth*2-1,vi.y=-(i.clientY/innerHeight)*2+1,qi.setFromCamera(vi,cn);const e=qi.intersectObject(Yt);for(const t of e){const n=Jt[t.instanceId];if(Xi(n))return n}return null}const Gi=document.getElementById("tip");function sg(i){const e=rc(i);if(Ti.style.cursor=e?"pointer":"default",!e){Gi.style.display="none";return}const t=dn.get(e.id);Gi.style.display="block",Gi.style.left=`${i.clientX+13}px`,Gi.style.top=`${i.clientY+13}px`,Gi.innerHTML=`<span class="swatch" style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.hex};margin-right:6px"></span>${e.label} <span style="color:#8792ab">· ${e.kind}</span>`}function ag(i){const e=rc(i);$r(e?e.id:null)}const Pa={roadmap:"The only view that looks forward. Both lists come from FULL_CAPACITY_PLAN.md: the activation ladder (§B) is the ordered flips still owed — violet means everything is deployed and it is only waiting on a human. The development queue (§C) is the slices; grey means planned with nothing built behind it.",system:"Who owns what. Systems come from the sole-writer matrix in SYSTEM_BOUNDARIES. Tables sit under their owner; a function sits under the system whose tables it touches, or — failing that — under the system whose functions it calls. Anything that fits neither is left unclassified rather than forced.",build:"Every migration in the order it landed, grouped by the day git first recorded it — the filename stamps are synthetic and would pile all 205 into one bucket. Each migration lists what it created.",feature:"Every feature gate, and the migrations that seed or read it. Sorted live first, unproven last.",timeline:"The whole arc in one view. Past — every shipped arc, the migration history behind it, and the complete build log from the dev log. Present — what production proves is live, plus the deploy frontier (merged, not yet deployed). Future — the activation ladder still owed and the planned queue."};let Yr="map",Tn=null,La=null;function sc(i){Yr=i,document.body.className=i,document.getElementById("treeWrap").classList.toggle("on",i==="tree"),document.getElementById("timelineWrap").classList.toggle("on",i==="timeline"),document.getElementById("scene").style.display=i==="map"?"block":"none",document.querySelectorAll("#tabs button").forEach(t=>t.classList.toggle("on",t.dataset.tab===i));const e=document.getElementById("search");if(e.value="",e.placeholder=i==="tree"?"Search the tree…":i==="timeline"?"Search the timeline…":"Search nodes…",i==="tree"){const t=!Tn;Tn??=Bm({graph:Lt,status:dn,svg:document.getElementById("tree"),onSelect:(n,r)=>{if(n)return $r(n);const s=document.getElementById("inspect");s.classList.add("on"),s.innerHTML=`<div class="kind">${r?.kind??"group"}</div>
          <h3>${r?.label??""}</h3>
          ...
          <div class="det">${r?.total??0} item(s) beneath this.</div>`}}),t?Tn.setMode(document.getElementById("treeMode").value):Tn.setQuery("")}else i==="timeline"?(La??=km({graph:Lt,status:dn,mount:document.getElementById("timeline"),onSelect:t=>$r(t)}),La.setQuery("")):(et.query="",Li());document.getElementById("treeHint").textContent=Pa[document.getElementById("treeMode").value],document.getElementById("timelineHint").textContent=Pa.timeline}document.querySelectorAll("#tabs button").forEach(i=>{i.addEventListener("click",()=>sc(i.dataset.tab))});document.getElementById("treeMode").addEventListener("change",i=>{Tn?.setMode(i.target.value),document.getElementById("treeHint").textContent=Pa[i.target.value]});document.getElementById("expandAll").addEventListener("click",()=>Tn?.expandAll());document.getElementById("collapseAll").addEventListener("click",()=>Tn?.collapseAll());window.__cam=()=>({dist:ui,yaw:Wi,pitch:di});document.getElementById("loading").remove();sc("map");Li();(function i(){if(requestAnimationFrame(i),pt.size){const e=Xt*.02;Br.set(-Math.sin(yn),0,-Math.cos(yn)),$i.set(Math.cos(yn),0,-Math.sin(yn)),(pt.has("w")||pt.has("arrowup"))&&Ut.addScaledVector(Br,e),(pt.has("s")||pt.has("arrowdown"))&&Ut.addScaledVector(Br,-e),(pt.has("d")||pt.has("arrowright"))&&Ut.addScaledVector($i,e),(pt.has("a")||pt.has("arrowleft"))&&Ut.addScaledVector($i,-e),(pt.has("e")||pt.has(" "))&&(Ut.y+=e),pt.has("q")&&(Ut.y-=e)}Ca&&!Mt&&!pt.size&&(yn+=4e-4),Wi+=(yn-Wi)*Cr,di+=(qr-di)*Cr,ui+=(Xt-ui)*Cr,ci.lerp(Ut,Cr),cn.position.set(ci.x+ui*Math.cos(di)*Math.sin(Wi),ci.y+ui*Math.sin(di),ci.z+ui*Math.cos(di)*Math.cos(Wi)),cn.lookAt(ci),Ka.render(Pi,cn)})();
