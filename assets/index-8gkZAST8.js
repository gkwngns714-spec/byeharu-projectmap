...
void main() {
	...
	`}function Lf(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,d=l===ta||l===na,c=l===wi||l===Ri;if(d||c){let p=e.get(a);const h=p!==void 0?p.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new Ho(i)),p=d?t.fromEquirectangular(a,p):t.fromCubemap(a,p),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),p.texture;if(p!==void 0)return p.texture;{const m=a.image;return d&&m&&m.height>0||c&&m&&s(m)?(t===null&&(t=new Ho(i)),p=d?t.fromEquirectangular(a):t.fromCubemap(a),p.texture.pmremVersion=a.pmremVersion,e.set(a,p),a.addEventListener("dispose",r),p.texture):null}}}return a}function s(a){let l=0;const d=6;for(let c=0;c<d;c++)a[c]!==void 0&&l++;return l===d}function r(a){const l=a.target;l.removeEventListener("dispose",r);const d=e.get(l);d!==void 0&&(e.delete(l),d.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Df(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Hs("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function If(i,e,t,n){const s={},r=new WeakMap;function o(p){const h=p.target;h.index!==null&&e.remove(h.index);for(const _ in h.attributes)e.remove(h.attributes[_]);for(const _ in h.morphAttributes){const M=h.morphAttributes[_];for(let f=0,u=M.length;f<u;f++)e.remove(M[f])}h.removeEventListener("dispose",o),delete s[h.id];const m=r.get(h);m&&(e.remove(m),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(p,h){return s[h.id]===!0||(h.addEventListener("dispose",o),s[h.id]=!0,t.memory.geometries++),h}function l(p){const h=p.attributes;for(const _ in h)e.update(h[_],i.ARRAY_BUFFER);const m=p.morphAttributes;for(const _ in m){const M=m[_];for(let f=0,u=M.length;f<u;f++)e.update(M[f],i.ARRAY_BUFFER)}}function d(p){const h=[],m=p.index,_=p.attributes.position;let M=0;if(m!==null){const T=m.array;M=m.version;for(let y=0,E=T.length;y<E;y+=3){const N=T[y+0],R=T[y+1],w=T[y+2];h.push(N,R,R,w,w,N)}}else if(_!==void 0){const T=_.array;M=_.version;for(let y=0,E=T.length/3-1;y<E;y+=3){const N=y+0,R=y+1,w=y+2;h.push(N,R,R,w,w,N)}}else return;const f=new(kl(h)?$l:Xl)(h,1);f.version=M;const u=r.get(p);u&&e.remove(u),r.set(p,f)}function c(p){const h=r.get(p);if(h){const m=p.index;m!==null&&h.version<m.version&&d(p)}else d(p);return r.get(p)}return{get:a,update:l,getWireframeAttribute:c}}function Uf(i,e,t){let n;function s(h){n=h}let r,o;function a(h){r=h.type,o=h.bytesPerElement}function l(h,m){i.drawElements(n,m,r,h*o),t.update(m,n,1)}function d(h,m,_){_!==0&&(i.drawElementsInstanced(n,m,r,h*o,_),t.update(m,n,_))}function c(h,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,h,0,_);let f=0;for(let u=0;u<_;u++)f+=m[u];t.update(f,n,1)}function p(h,m,_,M){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let u=0;u<h.length;u++)d(h[u]/o,m[u],M[u]);else{f.multiDrawElementsInstancedWEBGL(n,m,0,r,h,0,M,0,_);let u=0;for(let T=0;T<_;T++)u+=m[T];for(let T=0;T<M.length;T++)t.update(u,n,M[T])}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=d,this.renderMultiDraw=c,this.renderMultiDrawInstances=p}function Nf(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Ff(i,e,t){const n=new WeakMap,s=new nt;function r(o,a,l){const d=o.morphTargetInfluences,c=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,p=c!==void 0?c.length:0;let h=n.get(a);if(h===void 0||h.count!==p){let L=function(){w.dispose(),n.delete(a),a.removeEventListener("dispose",L)};h!==void 0&&h.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,M=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],u=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let y=0;m===!0&&(y=1),_===!0&&(y=2),M===!0&&(y=3);let E=a.attributes.position.count*y,N=1;E>e.maxTextureSize&&(N=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const R=new Float32Array(E*N*4*p),w=new Gl(R,E,N,p);w.type=Jt,w.needsUpdate=!0;const k=y*4;for(let g=0;g<p;g++){const S=f[g],W=u[g],V=T[g],q=E*N*4*g;for(let Z=0;Z<S.count;Z++){const A=Z*k;m===!0&&(s.fromBufferAttribute(S,Z),R[q+A+0]=s.x,R[q+A+1]=s.y,R[q+A+2]=s.z,R[q+A+3]=0),_===!0&&(s.fromBufferAttribute(W,Z),R[q+A+4]=s.x,R[q+A+5]=s.y,R[q+A+6]=s.z,R[q+A+7]=0),M===!0&&(s.fromBufferAttribute(V,Z),R[q+A+8]=s.x,R[q+A+9]=s.y,R[q+A+10]=s.z,R[q+A+11]=V.itemSize===4?s.w:1)}}h={count:p,texture:w,size:new We(E,N)},n.set(a,h),a.addEventListener("dispose",L)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let m=0;for(let M=0;M<d.length;M++)m+=d[M];const _=a.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",d)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Of(i,e,t,n){let s=new WeakMap;function r(l){const d=n.render.frame,c=l.geometry,p=e.get(l,c);if(s.get(p)!==d&&(e.update(p),s.set(p,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==d&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,d))),l.isSkinnedMesh){const h=l.skeleton;s.get(h)!==d&&(h.update(),s.set(h,d))}return p}function o(){s=new WeakMap}function a(l){const d=l.target;d.removeEventListener("dispose",a),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:r,dispose:o}}class Jl extends gt{constructor(e,t,n,s,r,o,a,l,d,c=Mi){if(c!==Mi&&c!==Pi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&c===Mi&&(n=qn),n===void 0&&c===Pi&&(n=Ci),super(null,s,r,o,a,l,c,n,d),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Et,this.minFilter=l!==void 0?l:Et,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Ql=new gt,Xo=new Jl(1,1),ec=new Gl,tc=new yd,nc=new Kl,$o=[],qo=[],Yo=new Float32Array(16),Ko=new Float32Array(9),jo=new Float32Array(4);function Fi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=$o[s];if(r===void 0&&(r=new Float32Array(s),$o[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function at(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ot(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function rr(i,e){let t=qo[e];t===void 0&&(t=new Int32Array(e),qo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Bf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function zf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2fv(this.addr,e),ot(t,e)}}function kf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;i.uniform3fv(this.addr,e),ot(t,e)}}function Hf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4fv(this.addr,e),ot(t,e)}}function Gf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;jo.set(n),i.uniformMatrix2fv(this.addr,!1,jo),ot(t,n)}}function Vf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Ko.set(n),i.uniformMatrix3fv(this.addr,!1,Ko),ot(t,n)}}function Wf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Yo.set(n),i.uniformMatrix4fv(this.addr,!1,Yo),ot(t,n)}}function Xf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function $f(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2iv(this.addr,e),ot(t,e)}}function qf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3iv(this.addr,e),ot(t,e)}}function Yf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4iv(this.addr,e),ot(t,e)}}function Kf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function jf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2uiv(this.addr,e),ot(t,e)}}function Zf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3uiv(this.addr,e),ot(t,e)}}function Jf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4uiv(this.addr,e),ot(t,e)}}function Qf(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Xo.compareFunction=zl,r=Xo):r=Ql,t.setTexture2D(e||r,s)}function ep(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||tc,s)}function tp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||nc,s)}function np(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||ec,s)}function ip(i){switch(i){case 5126:return Bf;case 35664:return zf;case 35665:return kf;case 35666:return Hf;case 35674:return Gf;case 35675:return Vf;case 35676:return Wf;case 5124:case 35670:return Xf;case 35667:case 35671:return $f;case 35668:case 35672:return qf;case 35669:case 35673:return Yf;case 5125:return Kf;case 36294:return jf;case 36295:return Zf;case 36296:return Jf;case 35678:case 36198:case 36298:case 36306:case 35682:return Qf;case 35679:case 36299:case 36307:return ep;case 35680:case 36300:case 36308:case 36293:return tp;case 36289:case 36303:case 36311:case 36292:return np}}function sp(i,e){i.uniform1fv(this.addr,e)}function rp(i,e){const t=Fi(e,this.size,2);i.uniform2fv(this.addr,t)}function ap(i,e){const t=Fi(e,this.size,3);i.uniform3fv(this.addr,t)}function op(i,e){const t=Fi(e,this.size,4);i.uniform4fv(this.addr,t)}function lp(i,e){const t=Fi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function cp(i,e){const t=Fi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function dp(i,e){const t=Fi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function hp(i,e){i.uniform1iv(this.addr,e)}function up(i,e){i.uniform2iv(this.addr,e)}function fp(i,e){i.uniform3iv(this.addr,e)}function pp(i,e){i.uniform4iv(this.addr,e)}function mp(i,e){i.uniform1uiv(this.addr,e)}function gp(i,e){i.uniform2uiv(this.addr,e)}function _p(i,e){i.uniform3uiv(this.addr,e)}function vp(i,e){i.uniform4uiv(this.addr,e)}function xp(i,e,t){const n=this.cache,s=e.length,r=rr(t,s);at(n,r)||(i.uniform1iv(this.addr,r),ot(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||Ql,r[o])}function Mp(i,e,t){const n=this.cache,s=e.length,r=rr(t,s);at(n,r)||(i.uniform1iv(this.addr,r),ot(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||tc,r[o])}function Sp(i,e,t){const n=this.cache,s=e.length,r=rr(t,s);at(n,r)||(i.uniform1iv(this.addr,r),ot(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||nc,r[o])}function yp(i,e,t){const n=this.cache,s=e.length,r=rr(t,s);at(n,r)||(i.uniform1iv(this.addr,r),ot(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||ec,r[o])}function Ep(i){switch(i){case 5126:return sp;case 35664:return rp;case 35665:return ap;case 35666:return op;case 35674:return lp;case 35675:return cp;case 35676:return dp;case 5124:case 35670:return hp;case 35667:case 35671:return up;case 35668:case 35672:return fp;case 35669:case 35673:return pp;case 5125:return mp;case 36294:return gp;case 36295:return _p;case 36296:return vp;case 35678:case 36198:case 36298:case 36306:case 35682:return xp;case 35679:case 36299:case 36307:return Mp;case 35680:case 36300:case 36308:case 36293:return Sp;case 36289:case 36303:case 36311:case 36292:return yp}}class bp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=ip(t.type)}}class Tp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Ep(t.type)}}class Ap{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const kr=/(\w+)(\])?(\[|\.)?/g;function Zo(i,e){i.seq.push(e),i.map[e.id]=e}function wp(i,e,t){const n=i.name,s=n.length;for(kr.lastIndex=0;;){const r=kr.exec(n),o=kr.lastIndex;let a=r[1];const l=r[2]==="]",d=r[3];if(l&&(a=a|0),d===void 0||d==="["&&o+2===s){Zo(t,d===void 0?new bp(a,i,e):new Tp(a,i,e));break}else{let p=t.map[a];p===void 0&&(p=new Ap(a),Zo(t,p)),t=p}}}class Gs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);wp(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function Jo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Rp=37297;let Cp=0;function Pp(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Lp(i){const e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(i);let n;switch(e===t?n="":e===Ks&&t===Ys?n="LinearDisplayP3ToLinearSRGB":e===Ys&&t===Ks&&(n="LinearSRGBToLinearDisplayP3"),i){case Un:case ir:return[n,"LinearTransferOETF"];case Kt:case ja:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Qo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Pp(i.getShaderSource(e),o)}else return s}function Dp(i,e){const t=Lp(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Ip(i,e){let t;switch(e){case Yc:t="Linear";break;case Kc:t="Reinhard";break;case jc:t="Cineon";break;case Zc:t="ACESFilmic";break;case Qc:t="AgX";break;case ed:t="Neutral";break;case Jc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Cs=new B;function Up(){qe.getLuminanceCoefficients(Cs);const i=Cs.x.toFixed(4),e=Cs.y.toFixed(4),t=Cs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Vp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===wl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===wc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(e="SHADOWMAP_TYPE_VSM"),e}function Wp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wi:case Ri:e="ENVMAP_TYPE_CUBE";break;case nr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Xp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ri:e="ENVMAP_MODE_REFRACTION";break}return e}function $p(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ga:e="ENVMAP_BLENDING_MULTIPLY";break;case $c:e="ENVMAP_BLENDING_MIX";break;case qc:e="ENVMAP_BLENDING_ADD";break}return e}function qp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Yp(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Vp(t),d=Wp(t),c=Xp(t),p=$p(t),h=qp(t),m=Np(t),_=Fp(r),M=s.createProgram();let f,u,T=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <section class="tl-sec">
        ...
        ${Ue}
      </section>`,o.size)for(const U of t.querySelectorAll("[data-goto]")){const $=o.get(U.dataset.goto);$&&(U.classList.add("wip"),U.style.setProperty("--wc",$))}}return t.addEventListener("click",L=>{const g=L.target.closest("[data-goto]");!g||!t.contains(g)||(r=g.dataset.goto,n?.(r),k())}),k(),{setQuery(L){s=L.trim().toLowerCase(),k()},setWip(L){o=L??new Map,k()}}}const Wr=i=>String(i).replace(/[<>&"]/g,e=>({"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;"})[e]);function ng({graph:i,status:e,mount:t,onSelect:n}){let s="",r=null;const o=new Map(i.nodes.map(p=>[p.id,p])),a=p=>e.get(p)??Ee.NEEDS_CHECK,l=p=>o.has(p);function d(p,h){if(!l(p))return`<span class="mth-missing" title="not found in the scanned graph">${Wr(h??p)}</span>`;const m=o.get(p),_=a(p),M=h??m.label,f=p===r?" sel":"",u=s&&!M.toLowerCase().includes(s)&&!m.label.toLowerCase().includes(s)?" dm":"";return`<span class="tl-fchip${f}${u}" data-goto="${Wr(p)}"
      ...
      </section>`}return t.addEventListener("click",p=>{const h=p.target.closest("[data-goto]");!h||!t.contains(h)||(r=h.dataset.goto,n?.(r),c())}),c(),{setQuery(p){s=p.trim().toLowerCase(),c()}}}const rc={system:5.2,rung:4.6,phase:4.2,flag:3.4,table:2.4,migration:1.7,function:1.3},ac=["creates","supersedes","extends","alters","drops","seeds","gated-by","calls","touches","owned-by","delivers","delivered-by","flips","waits-on"],ig={creates:"migration defines a function/table",supersedes:"migration re-creates a function an earlier one defined",extends:"migration alters a table an earlier one created",alters:"migration changes a table",drops:"migration removes a function",seeds:"migration inserts a game_config flag","gated-by":"migration reads a flag to gate behaviour",calls:"function calls another function",touches:"function reads/writes a table","owned-by":"table belongs to a system (sole writer)",delivers:"a plan slice delivers this feature gate","delivered-by":"a plan slice was delivered by this migration",flips:"an activation rung flips this flag","waits-on":"this rung waits on the one before it"},Vs="./",[Tt,yn,oc]=await Promise.all([fetch(`${Vs}graph.json`).then(i=>i.json()),fetch(`${Vs}live.json`).then(i=>i.json()).catch(()=>null),fetch(`${Vs}wip.json`).then(i=>i.json()).catch(()=>null)]),{status:Qt,why:sg,frontier:Sl}=Wm(Tt,yn),qt=Hm(Tt.nodes,Tt.edges),In=new Map(qt.map(i=>[i.id,i])),rg=new Map(qt.map((i,e)=>[i.id,e])),bn=new Map;for(const i of Tt.edges)bn.has(i.source)||bn.set(i.source,[]),bn.has(i.target)||bn.set(i.target,[]),bn.get(i.source).push({...i,dir:"out",other:i.target}),bn.get(i.target).push({...i,dir:"in",other:i.source});const Di=document.getElementById("scene"),so=new wm({canvas:Di,antialias:!0});so.setPixelRatio(Math.min(devicePixelRatio,2));const Oi=new Rm;Oi.fog=new to(461071,.0016);const un=new Ft(58,1,1,6e3);Oi.add(new Bm(16777215,1.5));const lc=new Om(16777215,1.1);lc.position.set(1,1,1);Oi.add(lc);const ag=new no(1,14,10),og=new Um({transparent:!0}),yt=new Lm(ag,og,qt.length);yt.instanceColor=new Ia(new Float32Array(qt.length*3),3);Oi.add(yt);const Rn=new ct,fn=new Float32Array(qt.length*3);qt.forEach((i,e)=>{const t=new Ie(Qt.get(i.id).color);fn[e*3]=t.r,fn[e*3+1]=t.g,fn[e*3+2]=t.b});const ns=new tn,Tn=new Float32Array(Tt.edges.length*6),Ws=new Float32Array(Tt.edges.length*6);Tt.edges.forEach((i,e)=>{const t=In.get(i.source),n=In.get(i.target);Tn.set([t.x,t.y,t.z,n.x,n.y,n.z],e*6)});ns.setAttribute("position",new Dt(Tn,3));ns.setAttribute("color",new Dt(Ws,3));const lg=new Im(ns,new ic({vertexColors:!0,transparent:!0,opacity:.3,depthWrite:!1,blending:Xr}));Oi.add(lg);const et={status:new Set(io),kind:new Set(["system","rung","phase","flag","table","migration","function"]),edge:new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),query:"",selected:null};let Zi=[],cc=new Set;const er=new Map;let Oa=[];const _i=new Map;let yi="map",Zt=null,Ji=null,Ba=null;const cg=i=>!et.query||i.label.toLowerCase().includes(et.query)||(i.detail??"").toLowerCase().includes(et.query);function Ei(i){return et.status.has(Qt.get(i.id).key)&&et.kind.has(i.kind)&&cg(i)}function jn(){const i=et.selected,e=i?new Set([i,...(bn.get(i)??[]).map(s=>s.other)]):null;let t=0;qt.forEach((s,r)=>{const o=Ei(s);o&&t++;const a=e&&!e.has(s.id),l=o?rc[s.kind]*(s.id===i?2.1:1)*(cc.has(s.id)?1.7:1):0;Rn.position.set(s.x,s.y,s.z),Rn.scale.setScalar(o?a?l*.55:l:0),Rn.updateMatrix(),yt.setMatrixAt(r,Rn.matrix);const d=a?.22:1;yt.instanceColor.array[r*3]=fn[r*3]*d,yt.instanceColor.array[r*3+1]=fn[r*3+1]*d,yt.instanceColor.array[r*3+2]=fn[r*3+2]*d}),yt.instanceMatrix.needsUpdate=!0,yt.instanceColor.needsUpdate=!0;let n=0;Tt.edges.forEach((s,r)=>{const o=In.get(s.source),a=In.get(s.target),l=et.edge.has(s.type)&&Ei(o)&&Ei(a)&&(!e||e.has(s.source)&&e.has(s.target));l&&n++;const d=l?new Ie(Qt.get(s.source).color):null;for(let c=0;c<2;c++){const p=r*6+c*3;if(Ws[p]=d?d.r:0,Ws[p+1]=d?d.g:0,Ws[p+2]=d?d.b:0,!l)Tn[p]=0,Tn[p+1]=0,Tn[p+2]=0;else{const h=c===0?o:a;Tn[p]=h.x,Tn[p+1]=h.y,Tn[p+2]=h.z}}}),ns.attributes.position.needsUpdate=!0,ns.attributes.color.needsUpdate=!0,_g(t,n)}const dc=i=>qt.reduce((e,t)=>(e[i(t)]=(e[i(t)]??0)+1,e),{}),dg=dc(i=>Qt.get(i.id).key),hg=dc(i=>i.kind),ug=Tt.edges.reduce((i,e)=>(i[e.type]=(i[e.type]??0)+1,i),{});function ar({id:i,label:e,color:t,count:n,checked:s,title:r,onChange:o}){const a=document.createElement("label");return a.className="row",r&&(a.title=r),a.innerHTML=`<input type="checkbox" ${s?"checked":""}/>
    ${t?`<span class="swatch" style="background:${t}"></span>`:""}
    <span>${e}</span><span class="count">${n}</span>`,a.querySelector("input").addEventListener("change",l=>{o(l.target.checked),jn()}),a}const fg=document.getElementById("statusFilters");for(const i of io){const e=Ee[i];fg.append(ar({label:e.label,color:e.hex,count:dg[i]??0,checked:!0,title:e.desc,onChange:t=>t?et.status.add(i):et.status.delete(i)}))}const pg=document.getElementById("kindFilters");for(const i of["rung","phase","system","flag","table","migration","function"])pg.append(ar({label:i,count:hg[i]??0,checked:!0,onChange:e=>e?et.kind.add(i):et.kind.delete(i)}));const mg=document.getElementById("edgeFilters");for(const i of ac)mg.append(ar({label:i,count:ug[i]??0,checked:et.edge.has(i),title:ig[i],onChange:e=>e?et.edge.add(i):et.edge.delete(i)}));let za=!1;document.getElementById("cameraOptions").append(ar({label:"Auto-rotate",count:"",checked:za,title:"Slowly orbit the map on its own while you are not dragging or flying",onChange:i=>{za=i}}));document.getElementById("search").addEventListener("input",i=>{const e=i.target.value;if(yi==="tree"){Zt?.setQuery(e);return}if(yi==="timeline"){Ji?.setQuery(e);return}if(yi==="method"){Ba?.setQuery(e);return}et.query=e.trim().toLowerCase(),jn()});document.getElementById("reset").addEventListener("click",()=>{et.status=new Set(io),et.kind=new Set(["rung","phase","system","flag","table","migration","function"]),et.edge=new Set(["creates","supersedes","extends","seeds","gated-by","owned-by","delivers","flips","waits-on"]),et.query="",et.selected=null,document.getElementById("search").value="",document.querySelectorAll("#statusFilters input, #kindFilters input").forEach(i=>{i.checked=!0}),document.querySelectorAll("#edgeFilters input").forEach((i,e)=>{i.checked=et.edge.has(ac[e])}),document.getElementById("inspect").classList.remove("on"),Nt.set(0,0,0),$t=520,An=.7,tr=.35,jn()});const gg=document.getElementById("subtitle");gg.textContent=`${Tt.counts.nodes} nodes · ${Tt.counts.edges} connections`;function _g(i,e){const t=document.getElementById("hud"),n=yn?.sources?.gameConfig?.ok,s=yn?.fetchedAt?new Date(yn.fetchedAt).toLocaleString():"—",r=yn?.deploy?.state??"unknown",o=r!=="success";t.innerHTML=`
    ...
    <div class="rel">
      ...
      `).join("")}
    </div>`,e.querySelectorAll("[data-goto]").forEach(o=>{o.addEventListener("click",()=>bi(o.dataset.goto))})}function bi(i){if(et.selected=i,vg(i),i){const e=In.get(i);Nt.set(e.x,e.y,e.z),$t=Math.min($t,340)}jn()}const Yt=document.getElementById("workingNow");function hc(i){Zi=i?.items??[],cc=new Set(Zi.flatMap(e=>e.nodes)),er.clear(),_i.clear(),Oa=[];for(const e of Zi){const t=e.color||"#ff2d95",n=new Ie(t);for(const s of e.nodes){_i.set(s,t);const r=rg.get(s);r!=null&&(er.set(r,n),Oa.push({i:r,n:qt[r],col:n}))}}xg(i),Zt?.setWip?.(_i),Ji?.setWip?.(_i),jn()}function xg(i){if(!Zi.length){Yt.innerHTML='<div class="wn-head"><span>Working now</span></div><div class="wn-empty">No open pull requests — nothing in flight.</div>',Yt.classList.add("on");return}const e=i?.generatedAt?new Date(i.generatedAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"",t=Zi.map(n=>{const s=n.nodes[0],r=(n.touches?.functions?.length??0)+(n.touches?.tables?.length??0),o=[n.stamp?n.stamp.slice(8):null,`#${n.pr}`,r?`${r} symbol${r===1?"":"s"}`:`${n.nodes.length} node${n.nodes.length===1?"":"s"}`].filter(Boolean).join(" · ");return`<div class="wn-item" data-node="${s}" title="Fly to it">
      <span class="wn-dot" style="background:${n.color}"></span>
      <span class="wn-body"><span class="wn-title">${n.title.replace(/</g,"&lt;")}</span>
      <span class="wn-meta">${o}</span></span></div>`}).join("");Yt.innerHTML=`<div class="wn-head"><span class="wn-live"></span><span>Working now</span><span class="wn-when">${e}</span><button class="wn-fold" title="Collapse" aria-label="Collapse">${Yt.classList.contains("folded")?"+":"–"}</button></div>${t}`,Yt.classList.add("on"),Yt.querySelector(".wn-fold")?.addEventListener("click",()=>{Yt.classList.toggle("folded"),Yt.querySelector(".wn-fold").textContent=Yt.classList.contains("folded")?"+":"–"}),Yt.querySelectorAll(".wn-item").forEach(n=>n.addEventListener("click",()=>{const s=n.getAttribute("data-node");In.has(s)&&bi(s)}))}let yl=oc?.generatedAt??null;hc(oc);setInterval(async()=>{if(!document.hidden)try{const i=await fetch(`${Vs}wip.json?t=${Math.floor(performance.now())}`).then(t=>t.json()),e=i?.generatedAt??null;if(e===yl)return;yl=e,hc(i)}catch{}},2e4);document.querySelectorAll(".fold[data-fold]").forEach(i=>{i.addEventListener("click",()=>{const e=document.getElementById(i.dataset.fold);e?.classList.toggle("folded"),i.textContent=e?.classList.contains("folded")?"+":"–"})});const ka=document.getElementById("declutter"),uc=()=>{const i=document.body.classList.toggle("clean");ka.setAttribute("aria-pressed",String(i)),ka.title=i?"Show panels (H)":"Hide all panels (H)"};ka.addEventListener("click",uc);addEventListener("keydown",i=>{i.key.toLowerCase()==="h"&&yi==="map"&&!mc()&&uc()});const fc=document.getElementById("menuBtn"),pc=document.getElementById("scrim");function ro(i){document.getElementById("controls").classList.toggle("open",i),pc.classList.toggle("on",i),fc.setAttribute("aria-expanded",String(i))}fc.addEventListener("click",()=>ro(!document.getElementById("controls").classList.contains("open")));pc.addEventListener("click",()=>ro(!1));addEventListener("keydown",i=>{i.key==="Escape"&&ro(!1)});const fi=new B(0,0,0),Nt=new B(0,0,0);let pi=520,ji=.7,mi=.35,Mt=null,$t=520,An=.7,tr=.35;const Ns=.22,pt=new Set,Mg=new Set(["w","a","s","d","q","e"," ","arrowup","arrowdown","arrowleft","arrowright"]),mc=()=>{const i=document.activeElement;return!!i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT")};addEventListener("keydown",i=>{if(yi!=="map"||mc())return;const e=i.key.toLowerCase();Mg.has(e)&&(pt.add(e),e===" "&&i.preventDefault())});addEventListener("keyup",i=>pt.delete(i.key.toLowerCase()));addEventListener("blur",()=>pt.clear());Di.addEventListener("contextmenu",i=>i.preventDefault());const Qi=new B,El=new B,Xs=new B;function gc(){const i=innerWidth,e=innerHeight;so.setSize(i,e),un.aspect=i/e,un.updateProjectionMatrix()}addEventListener("resize",gc);gc();const Lt=new Map;let vi=null;const _c=()=>{const[i,e]=[...Lt.values()];return Math.hypot(i.x-e.x,i.y-e.y)};Di.addEventListener("pointerdown",i=>{Di.setPointerCapture?.(i.pointerId),Lt.set(i.pointerId,{x:i.clientX,y:i.clientY}),Lt.size===2?(vi={d:_c(),dist:$t},Mt=null):Lt.size===1&&(Mt={x:i.clientX,y:i.clientY,moved:!1,pan:i.button===2||i.shiftKey})});function vc(i){const e=Lt.size;if(Lt.delete(i.pointerId),e===1&&Mt&&!Mt.moved&&yg(i),Lt.size<2&&(vi=null),Lt.size===0)Mt=null;else if(Lt.size===1){const[t]=[...Lt.values()];Mt={x:t.x,y:t.y,moved:!0}}}addEventListener("pointerup",vc);addEventListener("pointercancel",vc);addEventListener("pointermove",i=>{if(Lt.has(i.pointerId)&&Lt.set(i.pointerId,{x:i.clientX,y:i.clientY}),Lt.size===2&&vi){const e=_c();e>0&&vi.d>0&&($t=Math.max(40,Math.min(2200,vi.dist*(vi.d/e))));return}if(Mt){const e=i.clientX-Mt.x,t=i.clientY-Mt.y;if(Math.abs(e)+Math.abs(t)>4&&(Mt.moved=!0),Mt.pan){un.matrixWorld.extractBasis(Qi,El,Xs);const n=$t*.0016;Nt.addScaledVector(Qi,-e*n),Nt.addScaledVector(El,t*n)}else An-=e*.0034,tr=Math.max(-1.45,Math.min(1.45,tr-t*.0034));Mt.x=i.clientX,Mt.y=i.clientY}else i.pointerType==="mouse"&&Sg(i)});const bl=new B,Tl=new B,Al=new En;Di.addEventListener("wheel",i=>{i.preventDefault();let e=i.deltaY;i.deltaMode===1?e*=16:i.deltaMode===2&&(e*=400);const t=Math.max(-.2,Math.min(.2,e*.0022)),n=Math.max(40,Math.min(2200,$t*(1+t))),s=n/$t;if(s!==1){Ti.x=i.clientX/innerWidth*2-1,Ti.y=-(i.clientY/innerHeight)*2+1,es.setFromCamera(Ti,un);let r=null;for(const o of es.intersectObject(yt))if(Ei(qt[o.instanceId])){r=bl.copy(o.point);break}r||(un.getWorldDirection(Tl),Al.setFromNormalAndCoplanarPoint(Tl,fi),r=es.ray.intersectPlane(Al,bl)),r&&Nt.lerp(r,1-s)}$t=n},{passive:!1});const es=new zm,Ti=new We;function xc(i){Ti.x=i.clientX/innerWidth*2-1,Ti.y=-(i.clientY/innerHeight)*2+1,es.setFromCamera(Ti,un);const e=es.intersectObject(yt);for(const t of e){const n=qt[t.instanceId];if(Ei(n))return n}return null}const Yi=document.getElementById("tip");function Sg(i){const e=xc(i);if(Di.style.cursor=e?"pointer":"default",!e){Yi.style.display="none";return}const t=Qt.get(e.id);Yi.style.display="block",Yi.style.left=`${i.clientX+13}px`,Yi.style.top=`${i.clientY+13}px`,Yi.innerHTML=`<span class="swatch" style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.hex};margin-right:6px"></span>${e.label} <span style="color:#8792ab">· ${e.kind}</span>`}function yg(i){const e=xc(i);bi(e?e.id:null)}const $s={roadmap:"The only view that looks forward. Both lists come from FULL_CAPACITY_PLAN.md: the activation ladder (§B) is the ordered flips still owed — violet means everything is deployed and it is only waiting on a human. The development queue (§C) is the slices; grey means planned with nothing built behind it.",system:"Who owns what. Systems come from the sole-writer matrix in SYSTEM_BOUNDARIES. Tables sit under their owner; a function sits under the system whose tables it touches, or — failing that — under the system whose functions it calls. Anything that fits neither is left unclassified rather than forced.",build:"Every migration in the order it landed, grouped by the day git first recorded it — the filename stamps are synthetic and would pile all 205 into one bucket. Each migration lists what it created.",feature:"Every feature gate, and the migrations that seed or read it. Sorted live first, unproven last.",timeline:"The whole arc in one view. Past — every shipped arc, the migration history behind it, and the complete build log from the dev log. Present — what production proves is live, plus the deploy frontier (merged, not yet deployed). Future — the activation ladder still owed and the planned queue.",method:"How this codebase is actually built — the no-spaghetti law, the per-slice build loop (architect → implementer → adversarial reviewer → real-Postgres proof → owner-gated deploy), the verification discipline, and the server-authoritative stance. Every citation is a real node — click one to jump to it on the map. Grounded in docs/HOW_ITS_BUILT.md."};function Mc(i){yi=i,document.body.className=i,document.getElementById("treeWrap").classList.toggle("on",i==="tree"),document.getElementById("timelineWrap").classList.toggle("on",i==="timeline"),document.getElementById("methodWrap").classList.toggle("on",i==="method"),document.getElementById("scene").style.display=i==="map"?"block":"none",document.querySelectorAll("#tabs button").forEach(t=>t.classList.toggle("on",t.dataset.tab===i));const e=document.getElementById("search");if(e.value="",e.placeholder=i==="tree"?"Search the tree…":i==="timeline"?"Search the timeline…":i==="method"?"Search the method…":"Search nodes…",i==="tree"){const t=!Zt;Zt??=Qm({graph:Tt,status:Qt,svg:document.getElementById("tree"),onSelect:(n,s)=>{if(n)return bi(n);const r=document.getElementById("inspect");r.classList.add("on"),r.innerHTML=`<div class="kind">${s?.kind??"group"}</div>
          <h3>${s?.label??""}</h3>
